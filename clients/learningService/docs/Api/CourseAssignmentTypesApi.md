...
```php
getCourseAssignmentTypesAsync($tenant_id, $api_version, $x_api_version, $course_assignment_type_dto_collection_query_parameters): \OpenAPI\Client\Model\CourseAssignmentTypeDto[]
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$course_assignment_type_dto_collection_query_parameters = new \OpenAPI\Client\Model\CourseAssignmentTypeDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\CourseAssignmentTypeDtoCollectionQueryParameters

try {
    $result = $apiInstance->getCourseAssignmentTypesAsync($tenant_id, $api_version, $x_api_version, $course_assignment_type_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **course_assignment_type_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\CourseAssignmentTypeDtoCollectionQueryParameters**](../Model/CourseAssignmentTypeDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getCourseAssignmentTypesCountAsync($tenant_id, $api_version, $x_api_version, $course_assignment_type_dto_collection_query_parameters): int
```
...
try {
    $result = $apiInstance->getCourseAssignmentTypesCountAsync($tenant_id, $api_version, $x_api_version, $course_assignment_type_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchCourseAssignmentTypeAsync($tenant_id, $assignment_type_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchCourseAssignmentTypeAsync($tenant_id, $assignment_type_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CourseAssignmentTypesApi->patchCourseAssignmentTypeAsync: ', $e->getMessage(), PHP_EOL;
}
```
