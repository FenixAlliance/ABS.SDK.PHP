...
/**
 * CourseHandoutCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CourseHandoutCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CourseHandoutCreateDto';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CourseHandoutCreateDto., must be bigger than or equal to 1.');
        }
    ...
    public function setCourseId($course_id)
    {
        ...
        if ((mb_strlen($course_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $course_id when calling CourseHandoutCreateDto., must be bigger than or equal to 1.');
        }
    ...
    public function setBusinessId($business_id)
    {
        ...
        if ((mb_strlen($business_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $business_id when calling CourseHandoutCreateDto., must be bigger than or equal to 1.');
        }
