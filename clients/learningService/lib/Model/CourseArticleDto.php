...
/**
 * CourseArticleDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CourseArticleDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CourseArticleDto';
    ...
    */
     ...
     * Sets course_wiki_id
     *
     * @param string|null $course_wiki_id course_wiki_id
     *
     * @return self
     */
    public function setCourseWikiId($course_wiki_id)
    {
        if (is_null($course_wiki_id)) {
            array_push($this->openAPINullablesSetToNull, 'course_wiki_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('course_wiki_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
