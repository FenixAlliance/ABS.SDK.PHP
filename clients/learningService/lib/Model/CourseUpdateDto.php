...
/**
 * CourseUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CourseUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CourseUpdateDto';
    ...
    protected static array $openAPINullables = [
        ...
        'currency_id' => true,
        'regular_price' => true,
        'max_course_enrollments' => true,
        'total_effort_in_weeks' => true,
    ...
    */
    ...
    public function setMaxCourseEnrollments($max_course_enrollments)
    {
        if (is_null($max_course_enrollments)) {
            array_push($this->openAPINullablesSetToNull, 'max_course_enrollments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_course_enrollments', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTotalEffortInWeeks($total_effort_in_weeks)
    {
        if (is_null($total_effort_in_weeks)) {
            array_push($this->openAPINullablesSetToNull, 'total_effort_in_weeks');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('total_effort_in_weeks', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTotalHoursPerWeek($total_hours_per_week)
    {
        if (is_null($total_hours_per_week)) {
            array_push($this->openAPINullablesSetToNull, 'total_hours_per_week');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('total_hours_per_week', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
