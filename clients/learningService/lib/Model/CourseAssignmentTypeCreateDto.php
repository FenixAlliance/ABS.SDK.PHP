...
/**
 * CourseAssignmentTypeCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CourseAssignmentTypeCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CourseAssignmentTypeCreateDto';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CourseAssignmentTypeCreateDto., must be bigger than or equal to 1.');
        }
     ...
     * Sets excluded
     *
     * @param int|null $excluded excluded
     *
     * @return self
     */
    ...
    public function setCourseId($course_id)
    {
        ...
        if ((mb_strlen($course_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $course_id when calling CourseAssignmentTypeCreateDto., must be bigger than or equal to 1.');
        }
