...
class CoursesApi
{
    ...
    /**
     * Operation patchCourseAsyncWithHttpInfo
     *
     * Patch a course
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation patchCourseAsyncAsync
     *
     * Patch a course
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation patchCourseAsyncAsyncWithHttpInfo
     *
     * Patch a course
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'patchCourseAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $course_id (required)
     * @param  string $api_version (optional)
    ...
    public function patchCourseAsyncRequest($tenant_id, $course_id, $api_version = null, $x_api_version = null, $operation = null, string $contentType = self::contentTypes['patchCourseAsync'][0])
    {
        ...
        if ($tenant_id === null || (is_array($tenant_id) && count($tenant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tenant_id when calling patchCourseAsync'
            );
        }
        ...
        if ($course_id === null || (is_array($course_id) && count($course_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $course_id when calling patchCourseAsync'
            );
        }
