    ...
    */
    ...
    public function setInvoiceId($invoice_id)
    {
        ...
        if (!is_null($invoice_id) && (mb_strlen($invoice_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $invoice_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($invoice_id) && (mb_strlen($invoice_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $invoice_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEmisorWalletId($emisor_wallet_id)
    {
        ...
        if (!is_null($emisor_wallet_id) && (mb_strlen($emisor_wallet_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($emisor_wallet_id) && (mb_strlen($emisor_wallet_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setReceiverWalletId($receiver_wallet_id)
    {
        ...
        if (!is_null($receiver_wallet_id) && (mb_strlen($receiver_wallet_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($receiver_wallet_id) && (mb_strlen($receiver_wallet_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        if (!is_null($country_id) && (mb_strlen($country_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $country_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($country_id) && (mb_strlen($country_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setLocationId($location_id)
    {
        ...
        if (!is_null($location_id) && (mb_strlen($location_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($location_id) && (mb_strlen($location_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEntitlementId($entitlement_id)
    {
        ...
        if (!is_null($entitlement_id) && (mb_strlen($entitlement_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $entitlement_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($entitlement_id) && (mb_strlen($entitlement_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $entitlement_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setIpLookupId($ip_lookup_id)
    {
        ...
        if (!is_null($ip_lookup_id) && (mb_strlen($ip_lookup_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $ip_lookup_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($ip_lookup_id) && (mb_strlen($ip_lookup_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ip_lookup_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if (!is_null($order_id) && (mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($order_id) && (mb_strlen($order_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setAccountingEntryId($accounting_entry_id)
    {
        ...
        if (!is_null($accounting_entry_id) && (mb_strlen($accounting_entry_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $accounting_entry_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($accounting_entry_id) && (mb_strlen($accounting_entry_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $accounting_entry_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setPaymentGatewayId($payment_gateway_id)
    {
        ...
        if (!is_null($payment_gateway_id) && (mb_strlen($payment_gateway_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $payment_gateway_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($payment_gateway_id) && (mb_strlen($payment_gateway_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_gateway_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setBankAccountId($bank_account_id)
    {
        ...
        if (!is_null($bank_account_id) && (mb_strlen($bank_account_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($bank_account_id) && (mb_strlen($bank_account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setBankId($bank_id)
    {
        ...
        if (!is_null($bank_id) && (mb_strlen($bank_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $bank_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($bank_id) && (mb_strlen($bank_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setPaymentTokenId($payment_token_id)
    {
        ...
        if (!is_null($payment_token_id) && (mb_strlen($payment_token_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $payment_token_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($payment_token_id) && (mb_strlen($payment_token_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_token_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEmisorWalletAccountId($emisor_wallet_account_id)
    {
        ...
        if (!is_null($emisor_wallet_account_id) && (mb_strlen($emisor_wallet_account_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_account_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($emisor_wallet_account_id) && (mb_strlen($emisor_wallet_account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_account_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setReceiverWalletAccountId($receiver_wallet_account_id)
    {
        ...
        if (!is_null($receiver_wallet_account_id) && (mb_strlen($receiver_wallet_account_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_account_id when calling PaymentUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($receiver_wallet_account_id) && (mb_strlen($receiver_wallet_account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_account_id when calling PaymentUpdateDto., must be bigger than or equal to 0.');
        }
