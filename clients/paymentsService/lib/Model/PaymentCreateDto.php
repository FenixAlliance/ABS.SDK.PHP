    ...
    */
    ...
    public function setEnrolmentId($enrolment_id)
    {
        ...
        if (!is_null($enrolment_id) && (mb_strlen($enrolment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrolment_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrolment_id) && (mb_strlen($enrolment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrolment_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
