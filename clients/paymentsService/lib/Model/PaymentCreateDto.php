...
/**
 * PaymentCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentCreateDto';
    ...
    public const ON_BEHALF_OF_SELF = 'Self';
    public const ON_BEHALF_OF_TENANT = 'Tenant';
    public const ON_BEHALF_OF_INDIVIDUAL = 'Individual';
    public const ON_BEHALF_OF_ORGANIZATION = 'Organization';
    public const PAYMENT_TYPE_PAID = 'Paid';
    public const PAYMENT_TYPE_RECEIVED = 'Received';
    public const PAYMENT_TYPE_INTERNAL = 'Internal';
    public const PAYMENT_STATUS__UNSET = 'Unset';
    public const PAYMENT_STATUS_ACCEPTED = 'Accepted';
    public const PAYMENT_STATUS_REJECTED = 'Rejected';
    public const PAYMENT_STATUS_ON_HOLD = 'OnHold';
    public const PAYMENT_STATUS_FAILED = 'Failed';
    public const PAYMENT_STATUS_REVERSED = 'Reversed';
    public const PAYMENT_STATUS_RETAINED = 'Retained';
    public const PAYMENT_STATUS_INITIALIZED = 'Initialized';
    public const PAYMENT_STATUS_EXPIRED = 'Expired';
    public const PAYMENT_STATUS_ABANDONED = 'Abandoned';
    public const PAYMENT_STATUS_CANCELLED = 'Cancelled';
    public const PAYMENT_STATUS_ACCEPTED_RETAINED = 'AcceptedRetained';
    ...
    {
        return [
            self::ON_BEHALF_OF_SELF,
            self::ON_BEHALF_OF_TENANT,
            self::ON_BEHALF_OF_INDIVIDUAL,
            self::ON_BEHALF_OF_ORGANIZATION,
        ];
    }
    ...
    public function getPaymentTypeAllowableValues()
    {
        return [
            ...
            self::PAYMENT_TYPE_RECEIVED,
            self::PAYMENT_TYPE_INTERNAL,
        ];
    }
    ...
    {
        return [
            self::PAYMENT_STATUS__UNSET,
            self::PAYMENT_STATUS_ACCEPTED,
            self::PAYMENT_STATUS_REJECTED,
            self::PAYMENT_STATUS_ON_HOLD,
            self::PAYMENT_STATUS_FAILED,
            self::PAYMENT_STATUS_REVERSED,
            self::PAYMENT_STATUS_RETAINED,
            self::PAYMENT_STATUS_INITIALIZED,
            self::PAYMENT_STATUS_EXPIRED,
            self::PAYMENT_STATUS_ABANDONED,
            self::PAYMENT_STATUS_CANCELLED,
            self::PAYMENT_STATUS_ACCEPTED_RETAINED,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['emisor_wallet_id']) && (mb_strlen($this->container['emisor_wallet_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'emisor_wallet_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['emisor_wallet_id']) && (mb_strlen($this->container['emisor_wallet_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'emisor_wallet_id', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['receiver_wallet_id']) && (mb_strlen($this->container['receiver_wallet_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'receiver_wallet_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['receiver_wallet_id']) && (mb_strlen($this->container['receiver_wallet_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'receiver_wallet_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['location_id']) && (mb_strlen($this->container['location_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'location_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['location_id']) && (mb_strlen($this->container['location_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'location_id', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['entitlement_id']) && (mb_strlen($this->container['entitlement_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'entitlement_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['entitlement_id']) && (mb_strlen($this->container['entitlement_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'entitlement_id', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['ip_lookup_id']) && (mb_strlen($this->container['ip_lookup_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'ip_lookup_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['ip_lookup_id']) && (mb_strlen($this->container['ip_lookup_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'ip_lookup_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['accounting_entry_id']) && (mb_strlen($this->container['accounting_entry_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'accounting_entry_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['accounting_entry_id']) && (mb_strlen($this->container['accounting_entry_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'accounting_entry_id', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['payment_gateway_id']) && (mb_strlen($this->container['payment_gateway_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'payment_gateway_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['payment_gateway_id']) && (mb_strlen($this->container['payment_gateway_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'payment_gateway_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['payment_token_id']) && (mb_strlen($this->container['payment_token_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'payment_token_id', the character length must be smaller than or equal to 36.";
        }

        if (!is_null($this->container['payment_token_id']) && (mb_strlen($this->container['payment_token_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'payment_token_id', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setInvoiceId($invoice_id)
    {
        ...
        if (!is_null($invoice_id) && (mb_strlen($invoice_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $invoice_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($invoice_id) && (mb_strlen($invoice_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $invoice_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEmisorWalletId($emisor_wallet_id)
    {
        ...
        if (!is_null($emisor_wallet_id) && (mb_strlen($emisor_wallet_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($emisor_wallet_id) && (mb_strlen($emisor_wallet_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setReceiverWalletId($receiver_wallet_id)
    {
        ...
        if (!is_null($receiver_wallet_id) && (mb_strlen($receiver_wallet_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($receiver_wallet_id) && (mb_strlen($receiver_wallet_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        if (!is_null($country_id) && (mb_strlen($country_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $country_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($country_id) && (mb_strlen($country_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setLocationId($location_id)
    {
        ...
        if (!is_null($location_id) && (mb_strlen($location_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($location_id) && (mb_strlen($location_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEntitlementId($entitlement_id)
    {
        ...
        if (!is_null($entitlement_id) && (mb_strlen($entitlement_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $entitlement_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($entitlement_id) && (mb_strlen($entitlement_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $entitlement_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setIpLookupId($ip_lookup_id)
    {
        ...
        if (!is_null($ip_lookup_id) && (mb_strlen($ip_lookup_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $ip_lookup_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($ip_lookup_id) && (mb_strlen($ip_lookup_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ip_lookup_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if (!is_null($order_id) && (mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($order_id) && (mb_strlen($order_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setAccountingEntryId($accounting_entry_id)
    {
        ...
        if (!is_null($accounting_entry_id) && (mb_strlen($accounting_entry_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $accounting_entry_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($accounting_entry_id) && (mb_strlen($accounting_entry_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $accounting_entry_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setPaymentGatewayId($payment_gateway_id)
    {
        ...
        if (!is_null($payment_gateway_id) && (mb_strlen($payment_gateway_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $payment_gateway_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($payment_gateway_id) && (mb_strlen($payment_gateway_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_gateway_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setBankAccountId($bank_account_id)
    {
        ...
        if (!is_null($bank_account_id) && (mb_strlen($bank_account_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($bank_account_id) && (mb_strlen($bank_account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEnrollmentId($enrollment_id)
    {
        ...
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setBankId($bank_id)
    {
        ...
        if (!is_null($bank_id) && (mb_strlen($bank_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $bank_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($bank_id) && (mb_strlen($bank_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bank_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setPaymentTokenId($payment_token_id)
    {
        ...
        if (!is_null($payment_token_id) && (mb_strlen($payment_token_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $payment_token_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($payment_token_id) && (mb_strlen($payment_token_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_token_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEmisorWalletAccountId($emisor_wallet_account_id)
    {
        ...
        if (!is_null($emisor_wallet_account_id) && (mb_strlen($emisor_wallet_account_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_account_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($emisor_wallet_account_id) && (mb_strlen($emisor_wallet_account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $emisor_wallet_account_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setReceiverWalletAccountId($receiver_wallet_account_id)
    {
        ...
        if (!is_null($receiver_wallet_account_id) && (mb_strlen($receiver_wallet_account_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_account_id when calling PaymentCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($receiver_wallet_account_id) && (mb_strlen($receiver_wallet_account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $receiver_wallet_account_id when calling PaymentCreateDto., must be bigger than or equal to 0.');
        }
