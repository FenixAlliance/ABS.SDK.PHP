...
```php
getPaymentMethodsAsync($tenant_id, $api_version, $x_api_version, $payment_method_dto_collection_query_parameters): \OpenAPI\Client\Model\PaymentMethodDtoIReadOnlyListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$payment_method_dto_collection_query_parameters = new \OpenAPI\Client\Model\PaymentMethodDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\PaymentMethodDtoCollectionQueryParameters

try {
    $result = $apiInstance->getPaymentMethodsAsync($tenant_id, $api_version, $x_api_version, $payment_method_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **payment_method_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\PaymentMethodDtoCollectionQueryParameters**](../Model/PaymentMethodDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getPaymentMethodsCountAsync($tenant_id, $api_version, $x_api_version, $payment_method_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getPaymentMethodsCountAsync($tenant_id, $api_version, $x_api_version, $payment_method_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchPaymentMethodAsync($tenant_id, $payment_method_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchPaymentMethodAsync($tenant_id, $payment_method_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PaymentMethodsApi->patchPaymentMethodAsync: ', $e->getMessage(), PHP_EOL;
}
```
