...
/**
 * SupportTicketPriorityCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SupportTicketPriorityCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportTicketPriorityCreateDto';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SupportTicketPriorityCreateDto., must be smaller than or equal to 255.');
        }
        if (!is_null($title) && (mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SupportTicketPriorityCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SupportTicketPriorityCreateDto., must be smaller than or equal to 1000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SupportTicketPriorityCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setSupportEntitlementId($support_entitlement_id)
    {
        ...
        if (!is_null($support_entitlement_id) && (mb_strlen($support_entitlement_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $support_entitlement_id when calling SupportTicketPriorityCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($support_entitlement_id) && (mb_strlen($support_entitlement_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $support_entitlement_id when calling SupportTicketPriorityCreateDto., must be bigger than or equal to 36.');
        }
