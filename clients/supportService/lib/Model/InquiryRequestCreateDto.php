...
/**
 * InquiryRequestCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InquiryRequestCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InquiryRequestCreateDto';
    ...
    protected static $setters = [
        ...
        'job_role' => 'setJobRole',
        'organization_domain' => 'setOrganizationDomain',
    ...
    protected static $getters = [
        ...
        'job_role' => 'getJobRole',
        'organization_domain' => 'getOrganizationDomain',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('organization_domain', $data ?? [], null);
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InquiryRequestCreateDto., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InquiryRequestCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling InquiryRequestCreateDto., must be smaller than or equal to 255.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling InquiryRequestCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling InquiryRequestCreateDto., must be bigger than or equal to 1.');
        }
     ...
     * Sets job_role
     *
     * @param string|null $job_role job_role
     *
     * @return self
     */
    ...
    {
        if (is_null($job_role)) {
            array_push($this->openAPINullablesSetToNull, 'job_role');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('job_role', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets organization_domain
     *
     * @return string|null
     */
    public function getOrganizationDomain()
    {
        return $this->container['organization_domain'];
    }

    /**
     * Sets organization_domain
     *
     * @param string|null $organization_domain organization_domain
     *
     * @return self
     */
    public function setOrganizationDomain($organization_domain)
    {
        if (is_null($organization_domain)) {
            array_push($this->openAPINullablesSetToNull, 'organization_domain');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('organization_domain', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['organization_domain'] = $organization_domain;
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling InquiryRequestCreateDto., must be bigger than or equal to 1.');
        }
