...
------------ | ------------- | ------------- | -------------
*InventoryApi* | [**apiV2InventoryServiceInventoryStockItemIdDetailsGet**](docs/Api/InventoryApi.md#apiv2inventoryserviceinventorystockitemiddetailsget) | **GET** /api/v2/InventoryService/Inventory/{stockItemId}/Details | 
