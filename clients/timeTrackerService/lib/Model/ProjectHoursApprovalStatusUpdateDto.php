...
/**
 * ProjectHoursApprovalStatusUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectHoursApprovalStatusUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectHoursApprovalStatusUpdateDto';
    ...
    public const APPROVAL_STATUS_NUMBER_0 = 0;
    public const APPROVAL_STATUS_NUMBER_1 = 1;
    public const APPROVAL_STATUS_NUMBER_2 = 2;
    ...
    {
        return [
            self::APPROVAL_STATUS_NUMBER_0,
            self::APPROVAL_STATUS_NUMBER_1,
            self::APPROVAL_STATUS_NUMBER_2,
        ];
    }
    ...
    */
     ...
     *
     * @param int|null $approval_status approval_status
     *
     * @return self
     */
