...
class ProjectTimeLogDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const RECORD_TYPE_REGULAR_HOURS = 'RegularHours';
    public const RECORD_TYPE_OVERTIME_TO_PAY = 'OvertimeToPay';
    public const RECORD_TYPE_OVERTIME_TO_COMPENSATE = 'OvertimeToCompensate';
    ...
    {
        return [
            self::RECORD_TYPE_REGULAR_HOURS,
            self::RECORD_TYPE_OVERTIME_TO_PAY,
            self::RECORD_TYPE_OVERTIME_TO_COMPENSATE,
        ];
    }
