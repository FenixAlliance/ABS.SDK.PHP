...
/**
 * ProjectTimeLogCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectTimeLogCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectTimeLogCreateDto';
    ...
    public const PROJECT_TIME_LOG_RECORD_TYPE_REGULAR_HOURS = 'RegularHours';
    public const PROJECT_TIME_LOG_RECORD_TYPE_OVERTIME_TO_PAY = 'OvertimeToPay';
    public const PROJECT_TIME_LOG_RECORD_TYPE_OVERTIME_TO_COMPENSATE = 'OvertimeToCompensate';
    ...
    {
        return [
            self::PROJECT_TIME_LOG_RECORD_TYPE_REGULAR_HOURS,
            self::PROJECT_TIME_LOG_RECORD_TYPE_OVERTIME_TO_PAY,
            self::PROJECT_TIME_LOG_RECORD_TYPE_OVERTIME_TO_COMPENSATE,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['project_task_id'] === null) {
            $invalidProperties[] = "'project_task_id' can't be null";
        }
        if ((mb_strlen($this->container['project_task_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'project_task_id', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['project_period_id'] === null) {
            $invalidProperties[] = "'project_period_id' can't be null";
        }
        if ((mb_strlen($this->container['project_period_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'project_period_id', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setProjectTaskId($project_task_id)
    {
        ...
        if ((mb_strlen($project_task_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $project_task_id when calling ProjectTimeLogCreateDto., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $project_period_id project_period_id
     *
     * @return self
     */
    public function setProjectPeriodId($project_period_id)
    {
        if (is_null($project_period_id)) {
            throw new \InvalidArgumentException('non-nullable project_period_id cannot be null');
        }

        if ((mb_strlen($project_period_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $project_period_id when calling ProjectTimeLogCreateDto., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $project_time_log_record_type project_time_log_record_type
     *
     * @return self
     */
