...
```php
getAttributesForLicenseAsync($tenant_id, $license_id, $api_version, $x_api_version): \OpenAPI\Client\Model\SuiteLicenseAssignmentDtoListEnvelope
```
...
try {
    $result = $apiInstance->getAttributesForLicenseAsync($tenant_id, $license_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LicensingApi->getAttributesForLicenseAsync: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getFeaturesForLicenseAsync($tenant_id, $license_id, $api_version, $x_api_version): \OpenAPI\Client\Model\SuiteLicenseAssignmentDtoListEnvelope
```
...
try {
    $result = $apiInstance->getFeaturesForLicenseAsync($tenant_id, $license_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LicensingApi->getFeaturesForLicenseAsync: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getLicensesAsync($tenant_id, $api_version, $x_api_version): \OpenAPI\Client\Model\SuiteLicenseDtoListEnvelope
```
...
try {
    ...
    echo 'Exception when calling LicensingApi->getLicensesAsync: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
redeemLicenseAsync($tenant_id, $license_validation_request, $api_version, $x_api_version): \OpenAPI\Client\Model\BooleanEnvelope
```
...
try {
    $result = $apiInstance->redeemLicenseAsync($tenant_id, $license_validation_request, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LicensingApi->redeemLicenseAsync: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
validateLicenseAsync($license_validation_request, $api_version, $x_api_version): \OpenAPI\Client\Model\IValidationFailureListEnvelope
```
...
try {
    $result = $apiInstance->validateLicenseAsync($license_validation_request, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LicensingApi->validateLicenseAsync: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\IValidationFailureListEnvelope**](../Model/IValidationFailureListEnvelope.md)
