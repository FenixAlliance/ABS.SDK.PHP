...
/**
 * SuiteLicenseDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SuiteLicenseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuiteLicenseDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('license_string', $data ?? [], null);
    ...
    */
     ...
     * Sets license_string
     *
     * @param string|null $license_string license_string
     *
     * @return self
     */
    public function setLicenseString($license_string)
    {
        if (is_null($license_string)) {
            array_push($this->openAPINullablesSetToNull, 'license_string');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('license_string', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
