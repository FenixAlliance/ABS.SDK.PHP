...
/**
 * ApplicationPrincipalPermissionRequestDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationPrincipalPermissionRequestDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationPrincipalPermissionRequestDto';
    ...
    */
    ...
    public function setPermission($permission)
    {
        ...
        if ((mb_strlen($permission) < 1)) {
            throw new \InvalidArgumentException('invalid length for $permission when calling ApplicationPrincipalPermissionRequestDto., must be bigger than or equal to 1.');
        }
