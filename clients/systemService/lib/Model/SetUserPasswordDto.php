...
/**
 * SetUserPasswordDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetUserPasswordDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetUserPasswordDto';
    ...
    */
    ...
    public function setNewPassword($new_password)
    {
        ...
        if ((mb_strlen($new_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $new_password when calling SetUserPasswordDto., must be bigger than or equal to 1.');
        }
