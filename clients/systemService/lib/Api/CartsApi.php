...
class CartsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteSystemCart'] to see the possible values for this operation
     *
     ...
     */
    public function deleteSystemCart($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['deleteSystemCart'][0])
    {
        list($response) = $this->deleteSystemCartWithHttpInfo($cart_id, $api_version, $x_api_version, $contentType);
        return $response;
    }

    /**
     * Operation deleteSystemCartWithHttpInfo
     *
     * Delete a system cart
     *
     ...
     */
    public function deleteSystemCartWithHttpInfo($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['deleteSystemCart'][0])
    {
        $request = $this->deleteSystemCartRequest($cart_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Operation deleteSystemCartAsync
     *
     * Delete a system cart
     *
     * @param  string $cart_id (required)
     ...
     */
    public function deleteSystemCartAsync($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['deleteSystemCart'][0])
    {
        return $this->deleteSystemCartAsyncWithHttpInfo($cart_id, $api_version, $x_api_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteSystemCartAsyncWithHttpInfo
     *
     * Delete a system cart
     *
     * @param  string $cart_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSystemCartAsyncWithHttpInfo($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['deleteSystemCart'][0])
    {
        $returnType = '\OpenAPI\Client\Model\EmptyEnvelope';
        $request = $this->deleteSystemCartRequest($cart_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Create request for operation 'deleteSystemCart'
     *
     * @param  string $cart_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     ...
     */
    public function deleteSystemCartRequest($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['deleteSystemCart'][0])
    {

        // verify the required parameter 'cart_id' is set
        if ($cart_id === null || (is_array($cart_id) && count($cart_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling deleteSystemCart'
            );
        }
        ...
        $resourcePath = '/api/v2/SystemService/Carts/{cartId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $api_version api_version (optional)
     * @param  string $x_api_version x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSystemCartById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\CartDtoEnvelope
     */
    public function getSystemCartById($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSystemCartById'][0])
    {
        list($response) = $this->getSystemCartByIdWithHttpInfo($cart_id, $api_version, $x_api_version, $contentType);
        return $response;
    }

    /**
     * Operation getSystemCartByIdWithHttpInfo
     *
     * Retrieve a single system cart by its ID
     *
     * @param  string $cart_id (required)
     ...
     */
    public function getSystemCartByIdWithHttpInfo($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSystemCartById'][0])
    {
        $request = $this->getSystemCartByIdRequest($cart_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Operation getSystemCartByIdAsync
     *
     * Retrieve a single system cart by its ID
     *
     * @param  string $cart_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSystemCartByIdAsync($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSystemCartById'][0])
    {
        return $this->getSystemCartByIdAsyncWithHttpInfo($cart_id, $api_version, $x_api_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSystemCartByIdAsyncWithHttpInfo
     *
     * Retrieve a single system cart by its ID
     *
     * @param  string $cart_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSystemCartByIdAsyncWithHttpInfo($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSystemCartById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CartDtoEnvelope';
        $request = $this->getSystemCartByIdRequest($cart_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Create request for operation 'getSystemCartById'
     *
     * @param  string $cart_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSystemCartByIdRequest($cart_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSystemCartById'][0])
    {

        // verify the required parameter 'cart_id' is set
        if ($cart_id === null || (is_array($cart_id) && count($cart_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cart_id when calling getSystemCartById'
            );
        }
    ...
    /**
     * Operation getSystemCartsWithHttpInfo
     *
     * Retrieve a list of system carts
     *
     * @param  string $api_version (optional)
    ...
    public function getSystemCartsWithHttpInfo($api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSystemCarts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\CartDtoListEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CartDtoListEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CartDtoListEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CartDtoListEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getSystemCartsAsyncWithHttpInfo
     *
     * Retrieve a list of system carts
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Create request for operation 'getSystemCarts'
     *
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSystemCarts'] to see the possible values for this operation
    ...
    public function getSystemCartsRequest($api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSystemCarts'][0])
    {
        ...
        $resourcePath = '/api/v2/SystemService/Carts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getSystemCartsCountWithHttpInfo
     *
     * Get the count of system carts
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Operation getSystemCartsCountAsync
     *
     * Get the count of system carts
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Operation getSystemCartsCountAsyncWithHttpInfo
     *
     * Get the count of system carts
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Create request for operation 'getSystemCartsCount'
     *
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSystemCartsCount'] to see the possible values for this operation
