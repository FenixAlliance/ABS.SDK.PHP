...
class Claim implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'subject' => '\OpenAPI\Client\Model\ClaimsIdentity',
        'type' => 'string',
        'value' => 'string',
        'value_type' => 'string'
    ];
    ...
    protected static $setters = [
        'issuer' => 'setIssuer',
        'original_issuer' => 'setOriginalIssuer',
    ...
    protected static $getters = [
        'issuer' => 'getIssuer',
        'original_issuer' => 'getOriginalIssuer',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('original_issuer', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets original_issuer
     *
     * @return string|null
     */
    public function getOriginalIssuer()
    {
        return $this->container['original_issuer'];
    }

    /**
     * Sets original_issuer
     *
     * @param string|null $original_issuer original_issuer
     *
     * @return self
     */
    public function setOriginalIssuer($original_issuer)
    {
        if (is_null($original_issuer)) {
            array_push($this->openAPINullablesSetToNull, 'original_issuer');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('original_issuer', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['original_issuer'] = $original_issuer;
     ...
     * Sets subject
     *
     * @param \OpenAPI\Client\Model\ClaimsIdentity|null $subject subject
     *
     * @return self
     */
