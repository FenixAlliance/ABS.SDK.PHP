...
class QuoteCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'quote_status' => 'string',
        'quote_lines' => '\OpenAPI\Client\Model\QuoteLineCreateDto[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('quote_lines', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets quote_lines
     *
     * @return \OpenAPI\Client\Model\QuoteLineCreateDto[]|null
     */
     ...
     * Sets quote_lines
     *
     * @param \OpenAPI\Client\Model\QuoteLineCreateDto[]|null $quote_lines quote_lines
     *
     * @return self
     */
    public function setQuoteLines($quote_lines)
    {
        if (is_null($quote_lines)) {
            array_push($this->openAPINullablesSetToNull, 'quote_lines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('quote_lines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
