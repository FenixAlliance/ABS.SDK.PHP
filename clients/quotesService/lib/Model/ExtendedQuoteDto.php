...
/**
 * ExtendedQuoteDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExtendedQuoteDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtendedQuoteDto';
    ...
    public const QUOTE_STATUS_DRAFT = 'Draft';
    public const QUOTE_STATUS__NEW = 'New';
    ...
    {
        return [
            self::QUOTE_STATUS_DRAFT,
            self::QUOTE_STATUS__NEW,
            self::QUOTE_STATUS_ACCEPTED,
            self::QUOTE_STATUS_DECLINED,
            self::QUOTE_STATUS_EXPIRED,
        ];
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getDealUnitId()
    {
        return $this->container['deal_unit_id'];
    }

    /**
     * Sets deal_unit_id
     *
     * @param string|null $deal_unit_id deal_unit_id
     *
     * @return self
     */
    public function setDealUnitId($deal_unit_id)
    {
        if (is_null($deal_unit_id)) {
            array_push($this->openAPINullablesSetToNull, 'deal_unit_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deal_unit_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
