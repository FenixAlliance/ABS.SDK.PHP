...
/**
 * WorkstationUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WorkstationUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkstationUpdateDto';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if (!is_null($code) && (mb_strlen($code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code when calling WorkstationUpdateDto., must be smaller than or equal to 100.');
        }
        if (!is_null($code) && (mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling WorkstationUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setType($type)
    {
        ...
        if (!is_null($type) && (mb_strlen($type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $type when calling WorkstationUpdateDto., must be smaller than or equal to 100.');
        }
        if (!is_null($type) && (mb_strlen($type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $type when calling WorkstationUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WorkstationUpdateDto., must be smaller than or equal to 1000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WorkstationUpdateDto., must be bigger than or equal to 0.');
        }
