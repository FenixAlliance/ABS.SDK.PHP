...
*ActivityRecordsApi* | [**getActivityRecordsCountAsync**](docs/Api/ActivityRecordsApi.md#getactivityrecordscountasync) | **GET** /api/v2/ActivitiesService/ActivityRecords/Count | Count activity records
