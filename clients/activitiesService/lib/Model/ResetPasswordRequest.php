...
class ResetPasswordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reset_code', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reset_code'] === null) {
            $invalidProperties[] = "'reset_code' can't be null";
        }
    ...
    {
        return $this->container['reset_code'];
    }

    /**
     * Sets reset_code
     *
     * @param string $reset_code reset_code
     *
     * @return self
     */
    public function setResetCode($reset_code)
    {
        if (is_null($reset_code)) {
            array_push($this->openAPINullablesSetToNull, 'reset_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reset_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['reset_code'] = $reset_code;
