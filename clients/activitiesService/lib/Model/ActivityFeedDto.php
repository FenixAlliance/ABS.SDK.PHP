...
/**
 * ActivityFeedDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActivityFeedDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivityFeedDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activities_count', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $activities_count activities_count
     *
     * @return self
     */
    public function setActivitiesCount($activities_count)
    {
        if (is_null($activities_count)) {
            throw new \InvalidArgumentException('non-nullable activities_count cannot be null');
        }
