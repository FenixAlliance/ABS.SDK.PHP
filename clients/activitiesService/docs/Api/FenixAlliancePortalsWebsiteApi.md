# OpenAPI\Client\FenixAlliancePortalsWebsiteApi
...
$apiInstance = new OpenAPI\Client\Api\FenixAlliancePortalsWebsiteApi(
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->accountLogoutPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->accountManageDownloadPersonalDataPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->accountManageLinkExternalLoginPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->accountPerformExternalLoginPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->forgotPasswordPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->healthGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->helloGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->loginPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->manage2faPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->manageInfoGet: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->manageInfoPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->mapIdentityApiConfirmEmail: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->refreshPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->registerPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->resendConfirmationEmailPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->resetPasswordPost: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FenixAlliancePortalsWebsiteApi->versionGet: ', $e->getMessage(), PHP_EOL;
}
```
