...
/**
 * CognitiveAgentConversationCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CognitiveAgentConversationCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CognitiveAgentConversationCreateDto';
    ...
    */
    ...
    public function setChannelId($channel_id)
    {
        ...
        if (!is_null($channel_id) && (mb_strlen($channel_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $channel_id when calling CognitiveAgentConversationCreateDto., must be smaller than or equal to 255.');
        }
        if (!is_null($channel_id) && (mb_strlen($channel_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $channel_id when calling CognitiveAgentConversationCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setConversationId($conversation_id)
    {
        ...
        if (!is_null($conversation_id) && (mb_strlen($conversation_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $conversation_id when calling CognitiveAgentConversationCreateDto., must be smaller than or equal to 255.');
        }
        if (!is_null($conversation_id) && (mb_strlen($conversation_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $conversation_id when calling CognitiveAgentConversationCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $state when calling CognitiveAgentConversationCreateDto., must be smaller than or equal to 255.');
        }
        if (!is_null($state) && (mb_strlen($state) < 0)) {
            throw new \InvalidArgumentException('invalid length for $state when calling CognitiveAgentConversationCreateDto., must be bigger than or equal to 0.');
        }
