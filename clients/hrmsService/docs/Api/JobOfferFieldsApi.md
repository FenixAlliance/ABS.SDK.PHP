...
```php
getJobOfferFieldsAsync($tenant_id, $api_version, $x_api_version): \OpenAPI\Client\Model\JobOfferFieldRecordDtoListEnvelope
```
...
try {
    $result = $apiInstance->getJobOfferFieldsAsync($tenant_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
...
```php
getJobOfferFieldsCountAsync($tenant_id, $api_version, $x_api_version): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getJobOfferFieldsCountAsync($tenant_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
...
```php
patchJobOfferFieldAsync($tenant_id, $job_offer_field_id, $api_version, $x_api_version, $operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchJobOfferFieldAsync($tenant_id, $job_offer_field_id, $api_version, $x_api_version, $operation);
    print_r($result);
} catch (Exception $e) {
