...
```php
getJobFieldsAsync($tenant_id, $api_version, $x_api_version, $job_field_dto_collection_query_parameters): \OpenAPI\Client\Model\JobFieldDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$job_field_dto_collection_query_parameters = new \OpenAPI\Client\Model\JobFieldDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\JobFieldDtoCollectionQueryParameters

try {
    $result = $apiInstance->getJobFieldsAsync($tenant_id, $api_version, $x_api_version, $job_field_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **job_field_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\JobFieldDtoCollectionQueryParameters**](../Model/JobFieldDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getJobFieldsCountAsync($tenant_id, $api_version, $x_api_version, $job_field_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getJobFieldsCountAsync($tenant_id, $api_version, $x_api_version, $job_field_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchJobFieldAsync($tenant_id, $job_field_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchJobFieldAsync($tenant_id, $job_field_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
