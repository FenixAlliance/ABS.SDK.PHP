...
```php
getTrainingProgramCoursesAsync($tenant_id, $api_version, $x_api_version, $training_program_course_dto_collection_query_parameters): \OpenAPI\Client\Model\TrainingProgramCourseDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$training_program_course_dto_collection_query_parameters = new \OpenAPI\Client\Model\TrainingProgramCourseDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\TrainingProgramCourseDtoCollectionQueryParameters

try {
    $result = $apiInstance->getTrainingProgramCoursesAsync($tenant_id, $api_version, $x_api_version, $training_program_course_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **training_program_course_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\TrainingProgramCourseDtoCollectionQueryParameters**](../Model/TrainingProgramCourseDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getTrainingProgramCoursesCountAsync($tenant_id, $api_version, $x_api_version, $training_program_course_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getTrainingProgramCoursesCountAsync($tenant_id, $api_version, $x_api_version, $training_program_course_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchTrainingProgramCourseAsync($tenant_id, $course_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchTrainingProgramCourseAsync($tenant_id, $course_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
