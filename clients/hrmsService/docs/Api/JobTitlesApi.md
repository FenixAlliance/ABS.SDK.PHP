...
```php
getJobTitlesAsync($tenant_id, $api_version, $x_api_version, $job_title_dto_collection_query_parameters): \OpenAPI\Client\Model\JobTitleDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$job_title_dto_collection_query_parameters = new \OpenAPI\Client\Model\JobTitleDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\JobTitleDtoCollectionQueryParameters

try {
    $result = $apiInstance->getJobTitlesAsync($tenant_id, $api_version, $x_api_version, $job_title_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **job_title_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\JobTitleDtoCollectionQueryParameters**](../Model/JobTitleDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getJobTitlesCountAsync($tenant_id, $api_version, $x_api_version, $job_title_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getJobTitlesCountAsync($tenant_id, $api_version, $x_api_version, $job_title_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchJobTitleAsync($tenant_id, $job_title_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchJobTitleAsync($tenant_id, $job_title_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
