 ...
 */
class GigDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GigDto';
    ...
    */
     ...
     * Sets min_budget
     *
     * @param float|null $min_budget min_budget
     *
     * @return self
     */
    public function setMinBudget($min_budget)
    {
        if (is_null($min_budget)) {
            throw new \InvalidArgumentException('non-nullable min_budget cannot be null');
        }
