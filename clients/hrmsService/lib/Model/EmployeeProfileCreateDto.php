...
/**
 * EmployeeProfileCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeProfileCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeProfileCreateDto';
    ...
    */
    ...
    public function setMaxWorkHoursPerDay($max_work_hours_per_day)
    {
        if (is_null($max_work_hours_per_day)) {
            throw new \InvalidArgumentException('non-nullable max_work_hours_per_day cannot be null');
        }
