...
/**
 * EmployeeProfileDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmployeeProfileDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeProfileDto';
    ...
    protected static array $openAPINullables = [
        ...
        'gross_pay' => true,
        'net_salary' => true,
        'payroll_currency' => true,
        'max_work_hours_per_day' => true,
        'job_title_id' => true,
    ...
    protected static $setters = [
        ...
        'payroll_currency' => 'setPayrollCurrency',
        'max_work_hours_per_day' => 'setMaxWorkHoursPerDay',
        'job_title_id' => 'setJobTitleId',
        'employee_type_id' => 'setEmployeeTypeId'
    ];
    ...
    protected static $getters = [
        ...
        'payroll_currency' => 'getPayrollCurrency',
        'max_work_hours_per_day' => 'getMaxWorkHoursPerDay',
        'job_title_id' => 'getJobTitleId',
        'employee_type_id' => 'getEmployeeTypeId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payroll_currency', $data ?? [], null);
        $this->setIfExists('max_work_hours_per_day', $data ?? [], null);
        $this->setIfExists('job_title_id', $data ?? [], null);
        $this->setIfExists('employee_type_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function setGrossPay($gross_pay)
    {
        if (is_null($gross_pay)) {
            array_push($this->openAPINullablesSetToNull, 'gross_pay');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('gross_pay', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets net_salary
     *
     * @param float|null $net_salary net_salary
     *
     * @return self
     */
    public function setNetSalary($net_salary)
    {
        if (is_null($net_salary)) {
            array_push($this->openAPINullablesSetToNull, 'net_salary');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('net_salary', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets payroll_currency
     *
     * @return string|null
     */
    public function getPayrollCurrency()
    {
        return $this->container['payroll_currency'];
    }

    /**
     * Sets payroll_currency
     *
     * @param string|null $payroll_currency payroll_currency
     *
     * @return self
     */
    public function setPayrollCurrency($payroll_currency)
    {
        if (is_null($payroll_currency)) {
            array_push($this->openAPINullablesSetToNull, 'payroll_currency');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payroll_currency', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['payroll_currency'] = $payroll_currency;

        return $this;
    }

    /**
     * Gets max_work_hours_per_day
     *
     * @return int|null
     */
    public function getMaxWorkHoursPerDay()
    {
        return $this->container['max_work_hours_per_day'];
    }

    /**
     * Sets max_work_hours_per_day
     *
     * @param int|null $max_work_hours_per_day max_work_hours_per_day
     *
     * @return self
     */
    public function setMaxWorkHoursPerDay($max_work_hours_per_day)
    {
        if (is_null($max_work_hours_per_day)) {
            array_push($this->openAPINullablesSetToNull, 'max_work_hours_per_day');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_work_hours_per_day', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['max_work_hours_per_day'] = $max_work_hours_per_day;
    ...
    /**
     * Gets employee_type_id
     *
     * @return string|null
     */
    public function getEmployeeTypeId()
    {
        return $this->container['employee_type_id'];
    }

    /**
     * Sets employee_type_id
     *
     * @param string|null $employee_type_id employee_type_id
     *
     * @return self
     */
    public function setEmployeeTypeId($employee_type_id)
    {
        if (is_null($employee_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'employee_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('employee_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['employee_type_id'] = $employee_type_id;
