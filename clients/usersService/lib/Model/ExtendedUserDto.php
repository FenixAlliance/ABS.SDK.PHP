...
class ExtendedUserDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SITE_THEME_SYSTEM = 'System';
    public const SITE_THEME_LIGHT = 'Light';
    public const SITE_THEME_DARK = 'Dark';
    ...
    {
        return [
            self::SITE_THEME_SYSTEM,
            self::SITE_THEME_LIGHT,
            self::SITE_THEME_DARK,
        ];
    }
    ...
    */
     ...
     * Sets site_theme
     *
     * @param string|null $site_theme site_theme
     *
     * @return self
     */
