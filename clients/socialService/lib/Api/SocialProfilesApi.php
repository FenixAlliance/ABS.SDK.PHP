...
class SocialProfilesApi
{
    ...
    public function countMessagesAsyncRequest($social_profile_id, $conversation_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countMessagesAsync'][0])
    {
        ...
        if ($social_profile_id === null || (is_array($social_profile_id) && count($social_profile_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $social_profile_id when calling countMessagesAsync'
            );
        }
    ...
    public function getMessagesAsyncRequest($social_profile_id, $conversation_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getMessagesAsync'][0])
    {
        ...
        if ($social_profile_id === null || (is_array($social_profile_id) && count($social_profile_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $social_profile_id when calling getMessagesAsync'
            );
        }
     ...
     * @param  string $api_version api_version (optional)
     * @param  string $x_api_version x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getNotificationByIdAsync'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\NotificationDtoEnvelope
     */
    public function getNotificationByIdAsync($social_profile_id, $notification_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getNotificationByIdAsync'][0])
    {
        list($response) = $this->getNotificationByIdAsyncWithHttpInfo($social_profile_id, $notification_id, $api_version, $x_api_version, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\NotificationDtoEnvelope, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNotificationByIdAsyncWithHttpInfo($social_profile_id, $notification_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getNotificationByIdAsync'][0])
    {
        $request = $this->getNotificationByIdAsyncRequest($social_profile_id, $notification_id, $api_version, $x_api_version, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\NotificationDtoEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\NotificationDtoEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\NotificationDtoEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\NotificationDtoEnvelope';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\NotificationDtoEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getNotificationByIdAsyncAsync
     *
     * Get Notification
     *
     * @param  string $social_profile_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNotificationByIdAsyncAsync($social_profile_id, $notification_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getNotificationByIdAsync'][0])
    {
        return $this->getNotificationByIdAsyncAsyncWithHttpInfo($social_profile_id, $notification_id, $api_version, $x_api_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getNotificationByIdAsyncAsyncWithHttpInfo
     *
     * Get Notification
     *
     * @param  string $social_profile_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNotificationByIdAsyncAsyncWithHttpInfo($social_profile_id, $notification_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getNotificationByIdAsync'][0])
    {
        $returnType = '\OpenAPI\Client\Model\NotificationDtoEnvelope';
        $request = $this->getNotificationByIdAsyncRequest($social_profile_id, $notification_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Create request for operation 'getNotificationByIdAsync'
     *
     * @param  string $social_profile_id (required)
     * @param  string $notification_id (required)
     * @param  string $api_version (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getNotificationByIdAsyncRequest($social_profile_id, $notification_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getNotificationByIdAsync'][0])
    {

        // verify the required parameter 'social_profile_id' is set
        if ($social_profile_id === null || (is_array($social_profile_id) && count($social_profile_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $social_profile_id when calling getNotificationByIdAsync'
            );
        }
        ...
        if ($notification_id === null || (is_array($notification_id) && count($notification_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $notification_id when calling getNotificationByIdAsync'
            );
        }
        ...
        $resourcePath = '/api/v2/SocialService/SocialProfiles/{socialProfileId}/Notifications/{notificationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
