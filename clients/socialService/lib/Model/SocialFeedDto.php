...
/**
 * SocialFeedDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SocialFeedDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SocialFeedDto';
    ...
    protected static $setters = [
        ...
        'social_posts_count' => 'setSocialPostsCount',
    ...
    protected static $getters = [
        ...
        'social_posts_count' => 'getSocialPostsCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('social_posts_count', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets social_posts_count
     *
     * @return int|null
     */
    public function getSocialPostsCount()
    {
        return $this->container['social_posts_count'];
    }

    /**
     * Sets social_posts_count
     *
     * @param int|null $social_posts_count social_posts_count
     *
     * @return self
     */
    public function setSocialPostsCount($social_posts_count)
    {
        if (is_null($social_posts_count)) {
            throw new \InvalidArgumentException('non-nullable social_posts_count cannot be null');
        }
        $this->container['social_posts_count'] = $social_posts_count;
