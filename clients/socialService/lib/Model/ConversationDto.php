...
/**
 * ConversationDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConversationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationDto';
    ...
    protected static $setters = [
        ...
        'started_timestamp' => 'setStartedTimestamp',
    ...
    protected static $getters = [
        ...
        'started_timestamp' => 'getStartedTimestamp',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('started_timestamp', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets started_timestamp
     *
     * @return \DateTime|null
     */
    public function getStartedTimestamp()
    {
        return $this->container['started_timestamp'];
    }

    /**
     * Sets started_timestamp
     *
     * @param \DateTime|null $started_timestamp started_timestamp
     *
     * @return self
     */
    public function setStartedTimestamp($started_timestamp)
    {
        if (is_null($started_timestamp)) {
            throw new \InvalidArgumentException('non-nullable started_timestamp cannot be null');
        }
        $this->container['started_timestamp'] = $started_timestamp;
     ...
     *
     * @param \DateTime|null $last_message_timestamp last_message_timestamp
     *
     * @return self
     */
    public function setLastMessageTimestamp($last_message_timestamp)
    {
        if (is_null($last_message_timestamp)) {
            throw new \InvalidArgumentException('non-nullable last_message_timestamp cannot be null');
        }
