...
/**
 * SocialCommentReactionDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SocialCommentReactionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SocialCommentReactionDto';
    ...
    protected static $setters = [
        ...
        'social_comment_id' => 'setSocialCommentId'
    ];
    ...
    protected static $getters = [
        ...
        'social_comment_id' => 'getSocialCommentId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('social_comment_id', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets social_comment_id
     *
     * @return string|null
     */
    public function getSocialCommentId()
    {
        return $this->container['social_comment_id'];
    }

    /**
     * Sets social_comment_id
     *
     * @param string|null $social_comment_id social_comment_id
     *
     * @return self
     */
    public function setSocialCommentId($social_comment_id)
    {
        if (is_null($social_comment_id)) {
            array_push($this->openAPINullablesSetToNull, 'social_comment_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('social_comment_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['social_comment_id'] = $social_comment_id;
