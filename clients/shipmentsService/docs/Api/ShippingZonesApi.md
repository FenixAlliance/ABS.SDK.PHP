...
```php
getShippingZonesAsync($tenant_id, $api_version, $x_api_version): \OpenAPI\Client\Model\ShippingZoneDtoListEnvelope
```
...
try {
    $result = $apiInstance->getShippingZonesAsync($tenant_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
...
```php
getShippingZonesCountAsync($tenant_id, $api_version, $x_api_version): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getShippingZonesCountAsync($tenant_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
...
```php
patchShippingZoneAsync($tenant_id, $zone_id, $api_version, $x_api_version, $operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchShippingZoneAsync($tenant_id, $zone_id, $api_version, $x_api_version, $operation);
    print_r($result);
} catch (Exception $e) {
