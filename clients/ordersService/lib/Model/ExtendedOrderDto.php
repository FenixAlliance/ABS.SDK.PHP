...
class ExtendedOrderDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    /**
     * Gets seller_billing_profile_id
     *
     * @return string|null
     */
    public function getSellerBillingProfileId()
    {
        return $this->container['seller_billing_profile_id'];
    }

    /**
     * Sets seller_billing_profile_id
     *
     * @param string|null $seller_billing_profile_id seller_billing_profile_id
     *
     * @return self
     */
    public function setSellerBillingProfileId($seller_billing_profile_id)
    {
        if (is_null($seller_billing_profile_id)) {
            array_push($this->openAPINullablesSetToNull, 'seller_billing_profile_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('seller_billing_profile_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['seller_billing_profile_id'] = $seller_billing_profile_id;

        return $this;
    }

    /**
     * Gets buyer_billing_profile_id
     *
     * @return string|null
     */
    public function getBuyerBillingProfileId()
    {
        return $this->container['buyer_billing_profile_id'];
    }

    /**
     * Sets buyer_billing_profile_id
     *
     * @param string|null $buyer_billing_profile_id buyer_billing_profile_id
     *
     * @return self
     */
    public function setBuyerBillingProfileId($buyer_billing_profile_id)
    {
        if (is_null($buyer_billing_profile_id)) {
            array_push($this->openAPINullablesSetToNull, 'buyer_billing_profile_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('buyer_billing_profile_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
