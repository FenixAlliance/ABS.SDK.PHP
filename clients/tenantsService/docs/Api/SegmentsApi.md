...
```php
getTenantSegments($tenant_id, $api_version, $x_api_version, $tenant_segment_dto_collection_query_parameters): \OpenAPI\Client\Model\TenantSegmentDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$tenant_segment_dto_collection_query_parameters = new \OpenAPI\Client\Model\TenantSegmentDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\TenantSegmentDtoCollectionQueryParameters

try {
    $result = $apiInstance->getTenantSegments($tenant_id, $api_version, $x_api_version, $tenant_segment_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **tenant_segment_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\TenantSegmentDtoCollectionQueryParameters**](../Model/TenantSegmentDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getTenantSegmentsCount($tenant_id, $api_version, $x_api_version, $tenant_segment_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getTenantSegmentsCount($tenant_id, $api_version, $x_api_version, $tenant_segment_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchTenantSegment($tenant_id, $tenant_segment_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchTenantSegment($tenant_id, $tenant_segment_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SegmentsApi->patchTenantSegment: ', $e->getMessage(), PHP_EOL;
}
```
