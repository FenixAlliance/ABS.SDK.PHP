...
```php
getTenantSizes($tenant_id, $api_version, $x_api_version, $tenant_size_dto_collection_query_parameters): \OpenAPI\Client\Model\TenantSizeDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$tenant_size_dto_collection_query_parameters = new \OpenAPI\Client\Model\TenantSizeDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\TenantSizeDtoCollectionQueryParameters

try {
    $result = $apiInstance->getTenantSizes($tenant_id, $api_version, $x_api_version, $tenant_size_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **tenant_size_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\TenantSizeDtoCollectionQueryParameters**](../Model/TenantSizeDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getTenantSizesCount($tenant_id, $api_version, $x_api_version, $tenant_size_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getTenantSizesCount($tenant_id, $api_version, $x_api_version, $tenant_size_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchTenantSize($tenant_id, $tenant_size_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchTenantSize($tenant_id, $tenant_size_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SizesApi->patchTenantSize: ', $e->getMessage(), PHP_EOL;
}
```
