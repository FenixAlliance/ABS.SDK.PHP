...
```php
getTenantTypes($tenant_id, $api_version, $x_api_version, $tenant_type_dto_collection_query_parameters): \OpenAPI\Client\Model\TenantTypeDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$tenant_type_dto_collection_query_parameters = new \OpenAPI\Client\Model\TenantTypeDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\TenantTypeDtoCollectionQueryParameters

try {
    $result = $apiInstance->getTenantTypes($tenant_id, $api_version, $x_api_version, $tenant_type_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **tenant_type_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\TenantTypeDtoCollectionQueryParameters**](../Model/TenantTypeDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getTenantTypesCount($tenant_id, $api_version, $x_api_version, $tenant_type_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getTenantTypesCount($tenant_id, $api_version, $x_api_version, $tenant_type_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchTenantType($tenant_id, $tenant_type_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchTenantType($tenant_id, $tenant_type_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TypesApi->patchTenantType: ', $e->getMessage(), PHP_EOL;
}
```
