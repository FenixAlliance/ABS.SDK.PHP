...
```php
getTenantTeams($tenant_id, $api_version, $x_api_version, $tenant_team_dto_collection_query_parameters): \OpenAPI\Client\Model\TenantTeamDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$tenant_team_dto_collection_query_parameters = new \OpenAPI\Client\Model\TenantTeamDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\TenantTeamDtoCollectionQueryParameters

try {
    $result = $apiInstance->getTenantTeams($tenant_id, $api_version, $x_api_version, $tenant_team_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **tenant_team_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\TenantTeamDtoCollectionQueryParameters**](../Model/TenantTeamDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getTenantTeamsCount($tenant_id, $api_version, $x_api_version, $tenant_team_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getTenantTeamsCount($tenant_id, $api_version, $x_api_version, $tenant_team_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchTenantTeam($tenant_id, $tenant_team_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchTenantTeam($tenant_id, $tenant_team_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TeamsApi->patchTenantTeam: ', $e->getMessage(), PHP_EOL;
}
```
