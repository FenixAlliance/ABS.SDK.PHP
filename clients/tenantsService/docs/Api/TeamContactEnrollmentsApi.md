...
```php
getTenantTeamContactEnrollments($tenant_id, $api_version, $x_api_version, $tenant_team_contact_enrollment_dto_collection_query_parameters): \OpenAPI\Client\Model\TenantTeamContactEnrollmentDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$tenant_team_contact_enrollment_dto_collection_query_parameters = new \OpenAPI\Client\Model\TenantTeamContactEnrollmentDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\TenantTeamContactEnrollmentDtoCollectionQueryParameters

try {
    $result = $apiInstance->getTenantTeamContactEnrollments($tenant_id, $api_version, $x_api_version, $tenant_team_contact_enrollment_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **tenant_team_contact_enrollment_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\TenantTeamContactEnrollmentDtoCollectionQueryParameters**](../Model/TenantTeamContactEnrollmentDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getTenantTeamContactEnrollmentsCount($tenant_id, $api_version, $x_api_version, $tenant_team_contact_enrollment_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getTenantTeamContactEnrollmentsCount($tenant_id, $api_version, $x_api_version, $tenant_team_contact_enrollment_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchTenantTeamContactEnrollment($tenant_id, $tenant_team_contact_enrollment_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchTenantTeamContactEnrollment($tenant_id, $tenant_team_contact_enrollment_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TeamContactEnrollmentsApi->patchTenantTeamContactEnrollment: ', $e->getMessage(), PHP_EOL;
}
```
