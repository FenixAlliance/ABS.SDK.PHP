...
/**
 * MarketingListCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MarketingListCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketingListCreateDto';
    ...
    public const MARKETING_LIST_TYPE__STATIC = 'Static';
    public const MARKETING_LIST_TYPE_DYNAMIC = 'Dynamic';
    public const MARKETING_LIST_TARGET_INDIVIDUAL = 'Individual';
    public const MARKETING_LIST_TARGET_ORGANIZATION = 'Organization';
    public const MARKETING_LIST_TARGET_LEAD = 'Lead';
    ...
    {
        return [
            self::MARKETING_LIST_TYPE__STATIC,
            self::MARKETING_LIST_TYPE_DYNAMIC,
        ];
    }
    ...
    {
        return [
            self::MARKETING_LIST_TARGET_INDIVIDUAL,
            self::MARKETING_LIST_TARGET_ORGANIZATION,
            self::MARKETING_LIST_TARGET_LEAD,
        ];
    }
    ...
    */
     ...
     *
     * @param string|null $marketing_list_type marketing_list_type
     *
     * @return self
     */
     ...
     *
     * @param string|null $marketing_list_target marketing_list_target
     *
     * @return self
     */
