...
/**
 * EmailTemplateCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailTemplateCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailTemplateCreateDto';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new \InvalidArgumentException('invalid length for $title when calling EmailTemplateCreateDto., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 3)) {
            throw new \InvalidArgumentException('invalid length for $title when calling EmailTemplateCreateDto., must be bigger than or equal to 3.');
        }
    ...
    public function setMarketingCampaignId($marketing_campaign_id)
    {
        ...
        if (!is_null($marketing_campaign_id) && (mb_strlen($marketing_campaign_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $marketing_campaign_id when calling EmailTemplateCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($marketing_campaign_id) && (mb_strlen($marketing_campaign_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $marketing_campaign_id when calling EmailTemplateCreateDto., must be bigger than or equal to 0.');
        }
