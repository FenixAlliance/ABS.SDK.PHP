...
/**
 * SocialMediaPostUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SocialMediaPostUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SocialMediaPostUpdateDto';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 99)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SocialMediaPostUpdateDto., must be smaller than or equal to 99.');
        }
        if (!is_null($title) && (mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SocialMediaPostUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialPostBucketId($social_post_bucket_id)
    {
        ...
        if (!is_null($social_post_bucket_id) && (mb_strlen($social_post_bucket_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $social_post_bucket_id when calling SocialMediaPostUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($social_post_bucket_id) && (mb_strlen($social_post_bucket_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_post_bucket_id when calling SocialMediaPostUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEnrolmentId($enrolment_id)
    {
        ...
        if (!is_null($enrolment_id) && (mb_strlen($enrolment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrolment_id when calling SocialMediaPostUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrolment_id) && (mb_strlen($enrolment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrolment_id when calling SocialMediaPostUpdateDto., must be bigger than or equal to 0.');
        }
