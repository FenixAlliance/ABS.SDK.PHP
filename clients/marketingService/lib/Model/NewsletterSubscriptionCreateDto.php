...
/**
 * NewsletterSubscriptionCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NewsletterSubscriptionCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewsletterSubscriptionCreateDto';
    ...
    */
    ...
    public function setNewsletterId($newsletter_id)
    {
        if (is_null($newsletter_id)) {
            array_push($this->openAPINullablesSetToNull, 'newsletter_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('newsletter_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
