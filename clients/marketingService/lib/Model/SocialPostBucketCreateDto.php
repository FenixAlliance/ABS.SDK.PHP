...
/**
 * SocialPostBucketCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SocialPostBucketCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SocialPostBucketCreateDto';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 99)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SocialPostBucketCreateDto., must be smaller than or equal to 99.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SocialPostBucketCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEnrolmentId($enrolment_id)
    {
        ...
        if (!is_null($enrolment_id) && (mb_strlen($enrolment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrolment_id when calling SocialPostBucketCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrolment_id) && (mb_strlen($enrolment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrolment_id when calling SocialPostBucketCreateDto., must be bigger than or equal to 0.');
        }
