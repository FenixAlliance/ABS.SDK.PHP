 ...
 */
class InfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InfoResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_email_confirmed'] === null) {
            $invalidProperties[] = "'is_email_confirmed' can't be null";
        }
     ...
     *
     * @param bool $is_email_confirmed is_email_confirmed
     *
     * @return self
     */
