...
/**
 * SocialMediaPostCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SocialMediaPostCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SocialMediaPostCreateDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['title']) && (mb_strlen($this->container['title']) > 99)) {
            $invalidProperties[] = "invalid value for 'title', the character length must be smaller than or equal to 99.";
        }
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 99)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SocialMediaPostCreateDto., must be smaller than or equal to 99.');
        }
        if (!is_null($title) && (mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SocialMediaPostCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling SocialMediaPostCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling SocialMediaPostCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialPostBucketId($social_post_bucket_id)
    {
        ...
        if (!is_null($social_post_bucket_id) && (mb_strlen($social_post_bucket_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $social_post_bucket_id when calling SocialMediaPostCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($social_post_bucket_id) && (mb_strlen($social_post_bucket_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_post_bucket_id when calling SocialMediaPostCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEnrollmentId($enrollment_id)
    {
        ...
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling SocialMediaPostCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling SocialMediaPostCreateDto., must be bigger than or equal to 0.');
        }
