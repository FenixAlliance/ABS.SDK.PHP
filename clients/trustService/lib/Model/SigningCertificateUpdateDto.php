...
/**
 * SigningCertificateUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SigningCertificateUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SigningCertificateUpdateDto';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SigningCertificateUpdateDto., must be bigger than or equal to 1.');
        }
    ...
    public function setContactId($contact_id)
    {
        ...
        if ((mb_strlen($contact_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contact_id when calling SigningCertificateUpdateDto., must be bigger than or equal to 1.');
        }
