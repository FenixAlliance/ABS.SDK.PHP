...
/**
 * SigningEngineApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SigningEngineApi
{
    ...
    public function getProvidersAsyncWithHttpInfo($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getProvidersAsync'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\TrustSigningProviderDescriptorDtoListEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\TrustSigningProviderDescriptorDtoListEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\TrustSigningProviderDescriptorDtoListEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\TrustSigningProviderDescriptorDtoListEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getProvidersAsyncAsync
     *
     * List signing providers
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getProvidersAsyncAsyncWithHttpInfo
     *
     * List signing providers
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getProvidersAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getProvidersAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getProvidersAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/TrustService/SigningEngine/Providers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getProvidersCountAsyncAsync
     *
     * Count signing providers
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getProvidersCountAsyncAsyncWithHttpInfo
     *
     * Count signing providers
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getProvidersCountAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getProvidersCountAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getProvidersCountAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/TrustService/SigningEngine/Providers/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $api_version api_version (optional)
     * @param  string $x_api_version x_api_version (optional)
     * @param  \OpenAPI\Client\Model\TrustSigningRequestDto $trust_signing_request_dto trust_signing_request_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['previewAsync'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope
     */
    public function previewAsync($tenant_id, $api_version = null, $x_api_version = null, $trust_signing_request_dto = null, string $contentType = self::contentTypes['previewAsync'][0])
    {
        list($response) = $this->previewAsyncWithHttpInfo($tenant_id, $api_version, $x_api_version, $trust_signing_request_dto, $contentType);
        return $response;
    }
     ...
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     * @param  \OpenAPI\Client\Model\TrustSigningRequestDto $trust_signing_request_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['previewAsync'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope, HTTP status code, HTTP response headers (array of strings)
     */
    public function previewAsyncWithHttpInfo($tenant_id, $api_version = null, $x_api_version = null, $trust_signing_request_dto = null, string $contentType = self::contentTypes['previewAsync'][0])
    {
        $request = $this->previewAsyncRequest($tenant_id, $api_version, $x_api_version, $trust_signing_request_dto, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function previewAsyncAsync($tenant_id, $api_version = null, $x_api_version = null, $trust_signing_request_dto = null, string $contentType = self::contentTypes['previewAsync'][0])
    {
        return $this->previewAsyncAsyncWithHttpInfo($tenant_id, $api_version, $x_api_version, $trust_signing_request_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation previewAsyncAsyncWithHttpInfo
     *
     * Preview signing readiness
     *
     * @param  string $tenant_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function previewAsyncAsyncWithHttpInfo($tenant_id, $api_version = null, $x_api_version = null, $trust_signing_request_dto = null, string $contentType = self::contentTypes['previewAsync'][0])
    {
        $returnType = '\OpenAPI\Client\Model\TrustSigningReadinessDtoEnvelope';
        $request = $this->previewAsyncRequest($tenant_id, $api_version, $x_api_version, $trust_signing_request_dto, $contentType);
    ...
    /**
     * Create request for operation 'previewAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function previewAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, $trust_signing_request_dto = null, string $contentType = self::contentTypes['previewAsync'][0])
    {

        // verify the required parameter 'tenant_id' is set
        if ($tenant_id === null || (is_array($tenant_id) && count($tenant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tenant_id when calling previewAsync'
            );
        }
        ...
        $resourcePath = '/api/v2/TrustService/SigningEngine/Preview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($trust_signing_request_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($trust_signing_request_dto));
            } else {
                $httpBody = $trust_signing_request_dto;
            }
