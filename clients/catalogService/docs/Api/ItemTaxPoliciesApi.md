...
```php
countItemTaxPoliciesAsync($tenant_id, $item_id, $api_version, $x_api_version, $item_tax_policy_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->countItemTaxPoliciesAsync($tenant_id, $item_id, $api_version, $x_api_version, $item_tax_policy_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
getItemTaxPoliciesAsync($tenant_id, $item_id, $api_version, $x_api_version, $item_tax_policy_dto_collection_query_parameters): \OpenAPI\Client\Model\ItemTaxPolicyDtoListEnvelope
```
...
try {
    $result = $apiInstance->getItemTaxPoliciesAsync($tenant_id, $item_id, $api_version, $x_api_version, $item_tax_policy_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
