...
```php
patchItemAttributeAsync($tenant_id, $item_attribute_id, $api_version, $x_api_version, $operation)
```
...
try {
    $apiInstance->patchItemAttributeAsync($tenant_id, $item_attribute_id, $api_version, $x_api_version, $operation);
} catch (Exception $e) {
