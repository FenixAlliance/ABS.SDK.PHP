...
```php
getItemAttachmentsAsync($tenant_id, $api_version, $x_api_version, $item_attachment_dto_collection_query_parameters): \OpenAPI\Client\Model\ItemAttachmentDtoListEnvelope
```
...
try {
    $result = $apiInstance->getItemAttachmentsAsync($tenant_id, $api_version, $x_api_version, $item_attachment_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchItemAttachmentAsync($tenant_id, $item_attachment_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchItemAttachmentAsync($tenant_id, $item_attachment_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
