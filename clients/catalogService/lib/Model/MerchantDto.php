...
class MerchantDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'merchant_rating' => 'setMerchantRating'
    ];
    ...
    protected static $getters = [
        ...
        'merchant_rating' => 'getMerchantRating'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('merchant_rating', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets products_count
     *
     * @param int|null $products_count products_count
     *
     * @return self
     */
    ...
    /**
     * Gets merchant_rating
     *
     * @return float|null
     */
    public function getMerchantRating()
    {
        return $this->container['merchant_rating'];
    }

    /**
     * Sets merchant_rating
     *
     * @param float|null $merchant_rating merchant_rating
     *
     * @return self
     */
    public function setMerchantRating($merchant_rating)
    {
        if (is_null($merchant_rating)) {
            array_push($this->openAPINullablesSetToNull, 'merchant_rating');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('merchant_rating', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['merchant_rating'] = $merchant_rating;
