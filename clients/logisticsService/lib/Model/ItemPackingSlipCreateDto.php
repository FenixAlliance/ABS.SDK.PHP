...
/**
 * ItemPackingSlipCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ItemPackingSlipCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPackingSlipCreateDto';
    ...
    */
    ...
    public function setDeliveryNoteId($delivery_note_id)
    {
        if (is_null($delivery_note_id)) {
            array_push($this->openAPINullablesSetToNull, 'delivery_note_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delivery_note_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
