...
/**
 * ProofOfDeliveryLineDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProofOfDeliveryLineDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProofOfDeliveryLineDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('proof_of_delivery_id', $data ?? [], null);
        $this->setIfExists('line_number', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('quantity_expected', $data ?? [], null);
        $this->setIfExists('quantity_received', $data ?? [], null);
        $this->setIfExists('quantity_rejected', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets proof_of_delivery_id
     *
     * @return string|null
     */
    public function getProofOfDeliveryId()
    {
        return $this->container['proof_of_delivery_id'];
    }

    /**
     * Sets proof_of_delivery_id
     *
     * @param string|null $proof_of_delivery_id proof_of_delivery_id
     *
     * @return self
     */
    public function setProofOfDeliveryId($proof_of_delivery_id)
    {
        if (is_null($proof_of_delivery_id)) {
            array_push($this->openAPINullablesSetToNull, 'proof_of_delivery_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proof_of_delivery_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['proof_of_delivery_id'] = $proof_of_delivery_id;
     ...
     *
     * @param int|null $quantity_expected quantity_expected
     *
     * @return self
     */
    public function setQuantityExpected($quantity_expected)
    {
        if (is_null($quantity_expected)) {
            array_push($this->openAPINullablesSetToNull, 'quantity_expected');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('quantity_expected', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets quantity_rejected
     *
     * @return int|null
     */
    public function getQuantityRejected()
    {
        return $this->container['quantity_rejected'];
    }

    /**
     * Sets quantity_rejected
     *
     * @param int|null $quantity_rejected quantity_rejected
     *
     * @return self
     */
    public function setQuantityRejected($quantity_rejected)
    {
        if (is_null($quantity_rejected)) {
            array_push($this->openAPINullablesSetToNull, 'quantity_rejected');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('quantity_rejected', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['quantity_rejected'] = $quantity_rejected;
