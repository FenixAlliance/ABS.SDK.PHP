...
```php
getWarehousesAsync($tenant_id, $api_version, $x_api_version, $warehouse_dto_collection_query_parameters): \OpenAPI\Client\Model\WarehouseDtoListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$warehouse_dto_collection_query_parameters = new \OpenAPI\Client\Model\WarehouseDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\WarehouseDtoCollectionQueryParameters

try {
    $result = $apiInstance->getWarehousesAsync($tenant_id, $api_version, $x_api_version, $warehouse_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **warehouse_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\WarehouseDtoCollectionQueryParameters**](../Model/WarehouseDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getWarehousesCountAsync($tenant_id, $api_version, $x_api_version, $warehouse_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getWarehousesCountAsync($tenant_id, $api_version, $x_api_version, $warehouse_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchWarehouseAsync($tenant_id, $warehouse_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchWarehouseAsync($tenant_id, $warehouse_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
