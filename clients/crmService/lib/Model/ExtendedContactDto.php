...
/**
 * ExtendedContactDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExtendedContactDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtendedContactDto';
    ...
    protected static $openAPITypes = [
        ...
        'parent_contact' => '\OpenAPI\Client\Model\SimpleContactDto',
        'primary_contact' => '\OpenAPI\Client\Model\SimpleContactDto'
    ];
    ...
    protected static $setters = [
        ...
        'parent_contact' => 'setParentContact',
    ...
    protected static $getters = [
        ...
        'parent_contact' => 'getParentContact',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parent_contact', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['parent_contact'];
    }

    /**
     * Sets parent_contact
     *
     * @param \OpenAPI\Client\Model\SimpleContactDto|null $parent_contact parent_contact
     *
     * @return self
     */
    public function setParentContact($parent_contact)
    {
        if (is_null($parent_contact)) {
            throw new \InvalidArgumentException('non-nullable parent_contact cannot be null');
        }
        $this->container['parent_contact'] = $parent_contact;
     ...
     *
     * @param \OpenAPI\Client\Model\SimpleContactDto|null $primary_contact primary_contact
     *
     * @return self
     */
