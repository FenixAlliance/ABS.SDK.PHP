...
/**
 * PaymentTokenUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentTokenUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentTokenUpdateDto';
    ...
    */
    ...
    public function setPaymentGatewayId($payment_gateway_id)
    {
        ...
        if (!is_null($payment_gateway_id) && (mb_strlen($payment_gateway_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $payment_gateway_id when calling PaymentTokenUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($payment_gateway_id) && (mb_strlen($payment_gateway_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_gateway_id when calling PaymentTokenUpdateDto., must be bigger than or equal to 0.');
        }
