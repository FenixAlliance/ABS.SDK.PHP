...
```php
getProjectTasksAsync($tenant_id, $api_version, $x_api_version): \OpenAPI\Client\Model\ProjectTaskDtoListEnvelope
```
...
try {
    $result = $apiInstance->getProjectTasksAsync($tenant_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
...
```php
getProjectTasksCountAsync($tenant_id, $api_version, $x_api_version): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getProjectTasksCountAsync($tenant_id, $api_version, $x_api_version);
    print_r($result);
} catch (Exception $e) {
...
```php
patchProjectTaskAsync($tenant_id, $project_task_id, $api_version, $x_api_version, $operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchProjectTaskAsync($tenant_id, $project_task_id, $api_version, $x_api_version, $operation);
    print_r($result);
} catch (Exception $e) {
