...
/**
 * ServiceLevelAgreementCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceLevelAgreementCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceLevelAgreementCreateDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('service_level_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $service_level_id service_level_id
     *
     * @return self
     */
    public function setServiceLevelId($service_level_id)
    {
        if (is_null($service_level_id)) {
            array_push($this->openAPINullablesSetToNull, 'service_level_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('service_level_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
