...
```php
getServiceQueuesAsync($tenant_id, $api_version, $x_api_version, $service_queue_dto_collection_query_parameters): \OpenAPI\Client\Model\ServiceQueueDtoIReadOnlyListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$service_queue_dto_collection_query_parameters = new \OpenAPI\Client\Model\ServiceQueueDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\ServiceQueueDtoCollectionQueryParameters

try {
    $result = $apiInstance->getServiceQueuesAsync($tenant_id, $api_version, $x_api_version, $service_queue_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **service_queue_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\ServiceQueueDtoCollectionQueryParameters**](../Model/ServiceQueueDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getServiceQueuesCountAsync($tenant_id, $api_version, $x_api_version, $service_queue_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getServiceQueuesCountAsync($tenant_id, $api_version, $x_api_version, $service_queue_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchServiceQueueAsync($tenant_id, $service_queue_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\Envelope
```
...
try {
    $result = $apiInstance->patchServiceQueueAsync($tenant_id, $service_queue_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ServiceQueuesApi->patchServiceQueueAsync: ', $e->getMessage(), PHP_EOL;
}
```
