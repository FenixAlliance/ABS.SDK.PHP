...
```php
getServicesAsync($tenant_id, $api_version, $x_api_version, $service_dto_collection_query_parameters): \OpenAPI\Client\Model\ServiceDtoIReadOnlyListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$service_dto_collection_query_parameters = new \OpenAPI\Client\Model\ServiceDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\ServiceDtoCollectionQueryParameters

try {
    $result = $apiInstance->getServicesAsync($tenant_id, $api_version, $x_api_version, $service_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **service_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\ServiceDtoCollectionQueryParameters**](../Model/ServiceDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getServicesCountAsync($tenant_id, $api_version, $x_api_version, $service_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getServicesCountAsync($tenant_id, $api_version, $x_api_version, $service_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchServiceAsync($tenant_id, $service_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\Envelope
```
...
try {
    $result = $apiInstance->patchServiceAsync($tenant_id, $service_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ServicesApi->patchServiceAsync: ', $e->getMessage(), PHP_EOL;
}
```
