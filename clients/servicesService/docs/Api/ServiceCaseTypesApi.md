...
```php
getServiceCaseTypesAsync($tenant_id, $api_version, $x_api_version, $service_case_type_dto_collection_query_parameters): \OpenAPI\Client\Model\ServiceCaseTypeDtoIReadOnlyListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$service_case_type_dto_collection_query_parameters = new \OpenAPI\Client\Model\ServiceCaseTypeDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\ServiceCaseTypeDtoCollectionQueryParameters

try {
    $result = $apiInstance->getServiceCaseTypesAsync($tenant_id, $api_version, $x_api_version, $service_case_type_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **service_case_type_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\ServiceCaseTypeDtoCollectionQueryParameters**](../Model/ServiceCaseTypeDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getServiceCaseTypesCountAsync($tenant_id, $api_version, $x_api_version, $service_case_type_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getServiceCaseTypesCountAsync($tenant_id, $api_version, $x_api_version, $service_case_type_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchServiceCaseTypeAsync($tenant_id, $service_case_type_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\Envelope
```
...
try {
    $result = $apiInstance->patchServiceCaseTypeAsync($tenant_id, $service_case_type_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ServiceCaseTypesApi->patchServiceCaseTypeAsync: ', $e->getMessage(), PHP_EOL;
}
```
