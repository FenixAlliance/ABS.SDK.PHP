 ...
 */
class InfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InfoRequest';
    ...
    */
     ...
     * Sets new_email
     *
     * @param string|null $new_email new_email
     *
     * @return self
     */
    public function setNewEmail($new_email)
    {
        if (is_null($new_email)) {
            array_push($this->openAPINullablesSetToNull, 'new_email');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('new_email', $nullablesSetToNull);
            if ($index !== FALSE) {
