    ...
    */
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && (mb_strlen($item_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $item_id when calling DiscountUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($item_id) && (mb_strlen($item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $item_id when calling DiscountUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setDiscountListId($discount_list_id)
    {
        ...
        if (!is_null($discount_list_id) && (mb_strlen($discount_list_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $discount_list_id when calling DiscountUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($discount_list_id) && (mb_strlen($discount_list_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $discount_list_id when calling DiscountUpdateDto., must be bigger than or equal to 0.');
        }
