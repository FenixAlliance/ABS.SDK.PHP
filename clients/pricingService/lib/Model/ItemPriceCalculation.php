...
/**
 * ItemPriceCalculation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ItemPriceCalculation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPriceCalculation';
    ...
    protected static $openAPITypes = [
        ...
        'total_w_tax_amount' => '\OpenAPI\Client\Model\Money',
    ...
    protected static $setters = [
        ...
        'effective_tax_percent' => 'setEffectiveTaxPercent',
        ...
        'total_w_tax_amount' => 'setTotalWTaxAmount',
    ...
    protected static $getters = [
        ...
        'effective_tax_percent' => 'getEffectiveTaxPercent',
        ...
        'total_w_tax_amount' => 'getTotalWTaxAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('effective_tax_percent', $data ?? [], null);
        ...
        $this->setIfExists('total_w_tax_amount', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets effective_tax_percent
     *
     * @return float|null
     */
    public function getEffectiveTaxPercent()
    {
        return $this->container['effective_tax_percent'];
    }

    /**
     * Sets effective_tax_percent
     *
     * @param float|null $effective_tax_percent effective_tax_percent
     *
     * @return self
     */
    public function setEffectiveTaxPercent($effective_tax_percent)
    {
        if (is_null($effective_tax_percent)) {
            throw new \InvalidArgumentException('non-nullable effective_tax_percent cannot be null');
        }
        $this->container['effective_tax_percent'] = $effective_tax_percent;
    ...
    /**
     * Gets total_w_tax_amount
     *
     * @return \OpenAPI\Client\Model\Money|null
     */
    public function getTotalWTaxAmount()
    {
        return $this->container['total_w_tax_amount'];
    }

    /**
     * Sets total_w_tax_amount
     *
     * @param \OpenAPI\Client\Model\Money|null $total_w_tax_amount total_w_tax_amount
     *
     * @return self
     */
    public function setTotalWTaxAmount($total_w_tax_amount)
    {
        if (is_null($total_w_tax_amount)) {
            throw new \InvalidArgumentException('non-nullable total_w_tax_amount cannot be null');
        }
        $this->container['total_w_tax_amount'] = $total_w_tax_amount;
