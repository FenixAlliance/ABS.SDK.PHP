...
*PriceListsApi* | [**getPriceListPricesCountAsync**](docs/Api/PriceListsApi.md#getpricelistpricescountasync) | **GET** /api/v2/PricingService/PriceLists/{priceListId}/Prices/Count | Counts prices in a price list
