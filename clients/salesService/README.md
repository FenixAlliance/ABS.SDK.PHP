...
------------ | ------------- | ------------- | -------------
*MarginsApi* | [**apiV2SalesServiceMarginsMarginIdDetailsGet**](docs/Api/MarginsApi.md#apiv2salesservicemarginsmarginiddetailsget) | **GET** /api/v2/SalesService/Margins/{marginId}/Details | 
