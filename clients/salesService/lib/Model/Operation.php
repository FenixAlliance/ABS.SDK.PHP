...
class Operation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OPERATION_TYPE_REPLACE = 'Replace';
    public const OPERATION_TYPE_MOVE = 'Move';
    public const OPERATION_TYPE_COPY = 'Copy';
    public const OPERATION_TYPE_TEST = 'Test';
    public const OPERATION_TYPE_INVALID = 'Invalid';
    ...
    public function getOperationTypeAllowableValues()
    {
        return [
            ...
            self::OPERATION_TYPE_REPLACE,
            self::OPERATION_TYPE_MOVE,
            self::OPERATION_TYPE_COPY,
            self::OPERATION_TYPE_TEST,
            self::OPERATION_TYPE_INVALID,
        ];
    }
