...
class AccountUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountUpdateDto., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrencyId($currency_id)
    {
        ...
        if ((mb_strlen($currency_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency_id when calling AccountUpdateDto., must be bigger than or equal to 1.');
        }
