...
/**
 * FiscalResponsibilityUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FiscalResponsibilityUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FiscalResponsibilityUpdateDto';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FiscalResponsibilityUpdateDto., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FiscalResponsibilityUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setFiscalAuthorityId($fiscal_authority_id)
    {
        ...
        if (!is_null($fiscal_authority_id) && (mb_strlen($fiscal_authority_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_authority_id when calling FiscalResponsibilityUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($fiscal_authority_id) && (mb_strlen($fiscal_authority_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_authority_id when calling FiscalResponsibilityUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling FiscalResponsibilityUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling FiscalResponsibilityUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEnrollmentId($enrollment_id)
    {
        ...
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling FiscalResponsibilityUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling FiscalResponsibilityUpdateDto., must be bigger than or equal to 0.');
        }
