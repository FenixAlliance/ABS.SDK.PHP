...
/**
 * LoanApplicationUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoanApplicationUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoanApplicationUpdateDto';
    ...
    */
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling LoanApplicationUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling LoanApplicationUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEnrollmentId($enrollment_id)
    {
        ...
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling LoanApplicationUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling LoanApplicationUpdateDto., must be bigger than or equal to 0.');
        }
