...
/**
 * LedgerTypeUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LedgerTypeUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LedgerTypeUpdateDto';
     ...
     * @return string[]
     */
    public function getLedgerClassAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getLedgerClassAllowableValues();
        if (!is_null($this->container['ledger_class']) && !in_array($this->container['ledger_class'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'ledger_class', must be one of '%s'",
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling LedgerTypeUpdateDto., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling LedgerTypeUpdateDto., must be bigger than or equal to 0.');
        }
     ...
     * @return string|null
     */
    public function getLedgerClass()
    {
        return $this->container['ledger_class'];
    }

    /**
     * Sets ledger_class
     *
     * @param string|null $ledger_class ledger_class
     *
     * @return self
     */
    public function setLedgerClass($ledger_class)
    {
        if (is_null($ledger_class)) {
            array_push($this->openAPINullablesSetToNull, 'ledger_class');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ledger_class', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getLedgerClassAllowableValues();
        if (!is_null($ledger_class) && !in_array($ledger_class, $allowedValues, true)) {
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling LedgerTypeUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling LedgerTypeUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setEnrollmentId($enrollment_id)
    {
        ...
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling LedgerTypeUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($enrollment_id) && (mb_strlen($enrollment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $enrollment_id when calling LedgerTypeUpdateDto., must be bigger than or equal to 0.');
        }
