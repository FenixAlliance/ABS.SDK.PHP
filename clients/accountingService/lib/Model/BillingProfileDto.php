...
/**
 * BillingProfileDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BillingProfileDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingProfileDto';
    ...
    protected static $setters = [
        ...
        'fiscal_authority_name' => 'setFiscalAuthorityName',
    ...
    protected static $getters = [
        ...
        'fiscal_authority_name' => 'getFiscalAuthorityName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fiscal_authority_name', $data ?? [], null);
    ...
    */
    ...
    public function setTaxId($tax_id)
    {
        ...
        if ((mb_strlen($tax_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_id when calling BillingProfileDto., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling BillingProfileDto., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        if ((mb_strlen($country_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_id when calling BillingProfileDto., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets fiscal_authority_name
     *
     * @return string|null
     */
    public function getFiscalAuthorityName()
    {
        return $this->container['fiscal_authority_name'];
    }

    /**
     * Sets fiscal_authority_name
     *
     * @param string|null $fiscal_authority_name fiscal_authority_name
     *
     * @return self
     */
    public function setFiscalAuthorityName($fiscal_authority_name)
    {
        if (is_null($fiscal_authority_name)) {
            array_push($this->openAPINullablesSetToNull, 'fiscal_authority_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fiscal_authority_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['fiscal_authority_name'] = $fiscal_authority_name;
