...
/**
 * LoanUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoanUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoanUpdateDto';
    ...
    protected static $setters = [
        'loan_timestamp' => 'setLoanTimestamp',
    ...
    protected static $getters = [
        'loan_timestamp' => 'getLoanTimestamp',
    ...
    {
        $this->setIfExists('loan_timestamp', $data ?? [], null);
    ...
    */
     ...
     */
    public function getLoanTimestamp()
    {
        return $this->container['loan_timestamp'];
    }

    /**
     * Sets loan_timestamp
     *
     * @param \DateTime|null $loan_timestamp loan_timestamp
     *
     * @return self
     */
    public function setLoanTimestamp($loan_timestamp)
    {
        if (is_null($loan_timestamp)) {
            throw new \InvalidArgumentException('non-nullable loan_timestamp cannot be null');
        }
        $this->container['loan_timestamp'] = $loan_timestamp;
    ...
    /**
     * Gets is_compund_interest_rate
     *
     * @return bool|null
     */
    public function getIsCompundInterestRate()
    {
        return $this->container['is_compund_interest_rate'];
    }

    /**
     * Sets is_compund_interest_rate
     *
     * @param bool|null $is_compund_interest_rate is_compund_interest_rate
     *
     * @return self
     */
    public function setIsCompundInterestRate($is_compund_interest_rate)
    {
        if (is_null($is_compund_interest_rate)) {
            throw new \InvalidArgumentException('non-nullable is_compund_interest_rate cannot be null');
        }
        $this->container['is_compund_interest_rate'] = $is_compund_interest_rate;
    ...
    {
        return $this->container['loan_type_id'];
    }

    /**
     * Sets loan_type_id
     *
     * @param string|null $loan_type_id loan_type_id
     *
     * @return self
     */
    public function setLoanTypeId($loan_type_id)
    {
        if (is_null($loan_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'loan_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('loan_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['loan_type_id'] = $loan_type_id;
