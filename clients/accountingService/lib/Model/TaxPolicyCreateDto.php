...
/**
 * TaxPolicyCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TaxPolicyCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxPolicyCreateDto';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $title when calling TaxPolicyCreateDto., must be smaller than or equal to 50.');
        }
        if (!is_null($title) && (mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling TaxPolicyCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 150)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TaxPolicyCreateDto., must be smaller than or equal to 150.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TaxPolicyCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setCountryStateId($country_state_id)
    {
        ...
        if (!is_null($country_state_id) && (mb_strlen($country_state_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $country_state_id when calling TaxPolicyCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($country_state_id) && (mb_strlen($country_state_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $country_state_id when calling TaxPolicyCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setCityId($city_id)
    {
        ...
        if (!is_null($city_id) && (mb_strlen($city_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $city_id when calling TaxPolicyCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($city_id) && (mb_strlen($city_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city_id when calling TaxPolicyCreateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setFiscalAuthorityId($fiscal_authority_id)
    {
        ...
        if (!is_null($fiscal_authority_id) && (mb_strlen($fiscal_authority_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_authority_id when calling TaxPolicyCreateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($fiscal_authority_id) && (mb_strlen($fiscal_authority_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_authority_id when calling TaxPolicyCreateDto., must be bigger than or equal to 0.');
        }
