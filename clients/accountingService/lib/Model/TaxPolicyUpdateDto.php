...
class TaxPolicyUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'reduced' => false,
        'withholding' => false,
        'tax_scheme_code' => true,
        'tax_category_code' => true,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tax_scheme_code', $data ?? [], null);
        $this->setIfExists('tax_category_code', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['tax_scheme_code'];
    }

    /**
     * Sets tax_scheme_code
     *
     * @param string|null $tax_scheme_code tax_scheme_code
     *
     * @return self
     */
    public function setTaxSchemeCode($tax_scheme_code)
    {
        if (is_null($tax_scheme_code)) {
            array_push($this->openAPINullablesSetToNull, 'tax_scheme_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tax_scheme_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['tax_scheme_code'] = $tax_scheme_code;
     ...
     *
     * @param string|null $tax_category_code tax_category_code
     *
     * @return self
     */
    public function setTaxCategoryCode($tax_category_code)
    {
        if (is_null($tax_category_code)) {
            array_push($this->openAPINullablesSetToNull, 'tax_category_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tax_category_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
