...
```php
getFiscalYearsAsync($tenant_id, $api_version, $x_api_version, $fiscal_year_dto_collection_query_parameters): \OpenAPI\Client\Model\FiscalYearDtoIReadOnlyListEnvelope
```
...
try {
    $result = $apiInstance->getFiscalYearsAsync($tenant_id, $api_version, $x_api_version, $fiscal_year_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
getFiscalYearsCountAsync($tenant_id, $api_version, $x_api_version, $fiscal_year_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getFiscalYearsCountAsync($tenant_id, $api_version, $x_api_version, $fiscal_year_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchFiscalYearAsync($tenant_id, $fiscal_year_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchFiscalYearAsync($tenant_id, $fiscal_year_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FiscalYearsApi->patchFiscalYearAsync: ', $e->getMessage(), PHP_EOL;
}
```
