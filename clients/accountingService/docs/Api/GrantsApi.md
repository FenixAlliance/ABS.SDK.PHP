...
```php
getGrantsAsync($tenant_id, $api_version, $x_api_version, $grant_dto_collection_query_parameters): \OpenAPI\Client\Model\GrantDtoIReadOnlyListEnvelope
```
...
$api_version = 'api_version_example'; // string
$x_api_version = 'x_api_version_example'; // string
$grant_dto_collection_query_parameters = new \OpenAPI\Client\Model\GrantDtoCollectionQueryParameters(); // \OpenAPI\Client\Model\GrantDtoCollectionQueryParameters

try {
    $result = $apiInstance->getGrantsAsync($tenant_id, $api_version, $x_api_version, $grant_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
| **api_version** | **string**|  | [optional] |
| **x_api_version** | **string**|  | [optional] |
| **grant_dto_collection_query_parameters** | [**\OpenAPI\Client\Model\GrantDtoCollectionQueryParameters**](../Model/GrantDtoCollectionQueryParameters.md)|  | [optional] |
...
```php
getGrantsCountAsync($tenant_id, $api_version, $x_api_version, $grant_dto_collection_query_parameters): \OpenAPI\Client\Model\Int32Envelope
```
...
try {
    $result = $apiInstance->getGrantsCountAsync($tenant_id, $api_version, $x_api_version, $grant_dto_collection_query_parameters);
    print_r($result);
} catch (Exception $e) {
...
```php
patchGrantAsync($tenant_id, $grant_id, $api_version, $x_api_version, $patch_operation): \OpenAPI\Client\Model\EmptyEnvelope
```
...
try {
    $result = $apiInstance->patchGrantAsync($tenant_id, $grant_id, $api_version, $x_api_version, $patch_operation);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling GrantsApi->patchGrantAsync: ', $e->getMessage(), PHP_EOL;
}
```
