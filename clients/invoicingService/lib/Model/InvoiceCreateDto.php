...
class InvoiceCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'valid_from' => '\DateTime',
        'valid_to' => '\DateTime',
        'invoice_lines' => '\OpenAPI\Client\Model\InvoiceLineCreateDto[]',
        'invoice_references' => '\OpenAPI\Client\Model\InvoiceReferenceCreateDto[]',
        'invoice_adjustments' => '\OpenAPI\Client\Model\InvoiceAdjustmentCreateDto[]'
    ];
    ...
    public const INVOICE_TYPE_PURCHASE_INVOICE = 'PurchaseInvoice';
    public const INVOICE_TYPE_SALES_INVOICE = 'SalesInvoice';
    public const INVOICE_TYPE_CREDIT_NOTE = 'CreditNote';
    public const INVOICE_TYPE_DEBIT_NOTE = 'DebitNote';
    ...
    public const INVOICE_STATUS_SIGNED = 'Signed';
    ...
    {
        return [
            self::INVOICE_TYPE_PURCHASE_INVOICE,
            self::INVOICE_TYPE_SALES_INVOICE,
            self::INVOICE_TYPE_CREDIT_NOTE,
            self::INVOICE_TYPE_DEBIT_NOTE,
        ];
    }
    ...
    */
     ...
     * Gets invoice_lines
     *
     * @return \OpenAPI\Client\Model\InvoiceLineCreateDto[]|null
     */
     ...
     * Sets invoice_lines
     *
     * @param \OpenAPI\Client\Model\InvoiceLineCreateDto[]|null $invoice_lines invoice_lines
     *
     * @return self
     */
    public function setInvoiceLines($invoice_lines)
    {
        if (is_null($invoice_lines)) {
            array_push($this->openAPINullablesSetToNull, 'invoice_lines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invoice_lines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \OpenAPI\Client\Model\InvoiceReferenceCreateDto[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InvoiceReferenceCreateDto[]|null $invoice_references invoice_references
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\InvoiceAdjustmentCreateDto[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InvoiceAdjustmentCreateDto[]|null $invoice_adjustments invoice_adjustments
     *
     * @return self
     */
