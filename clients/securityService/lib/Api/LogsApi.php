...
class LogsApi
{
    ...
    public function getLogsAsyncWithHttpInfo($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLogsAsync'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\LogDtoListEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\LogDtoListEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\LogDtoListEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\LogDtoListEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getLogsAsyncAsyncWithHttpInfo
     *
     * Get tenant logs
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getLogsAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getLogsAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLogsAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/Logs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getLogsCountAsyncWithHttpInfo
     *
     * Get tenant logs count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getLogsCountAsyncAsync
     *
     * Get tenant logs count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getLogsCountAsyncAsyncWithHttpInfo
     *
     * Get tenant logs count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getLogsCountAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getLogsCountAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLogsCountAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/Logs/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
