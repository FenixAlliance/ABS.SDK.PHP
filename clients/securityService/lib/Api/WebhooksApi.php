...
class WebhooksApi
{
    ...
    public function getWebhookRequestsAsyncWithHttpInfo($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getWebhookRequestsAsync'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\WebhookRequestDtoListEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WebhookRequestDtoListEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WebhookRequestDtoListEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\WebhookRequestDtoListEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getWebhookRequestsAsyncAsync
     *
     * Get all webhook requests
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getWebhookRequestsAsyncAsyncWithHttpInfo
     *
     * Get all webhook requests
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getWebhookRequestsAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getWebhookRequestsAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getWebhookRequestsAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/Webhooks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getWebhookRequestsCountAsyncWithHttpInfo
     *
     * Get webhook requests count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getWebhookRequestsCountAsyncAsync
     *
     * Get webhook requests count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getWebhookRequestsCountAsyncAsyncWithHttpInfo
     *
     * Get webhook requests count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getWebhookRequestsCountAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getWebhookRequestsCountAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getWebhookRequestsCountAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/Webhooks/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
