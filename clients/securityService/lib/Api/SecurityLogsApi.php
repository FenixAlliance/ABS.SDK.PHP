...
/**
 * SecurityLogsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SecurityLogsApi
{
    ...
    /**
     * Operation getSecurityLogsAsyncWithHttpInfo
     *
     * Get business security logs
     *
    ...
    public function getSecurityLogsAsyncWithHttpInfo($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSecurityLogsAsync'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\BusinessSecurityLogDtoListEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\BusinessSecurityLogDtoListEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\BusinessSecurityLogDtoListEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\BusinessSecurityLogDtoListEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getSecurityLogsAsyncAsync
     *
     * Get business security logs
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getSecurityLogsAsyncAsyncWithHttpInfo
     *
     * Get business security logs
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getSecurityLogsAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getSecurityLogsAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSecurityLogsAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/SecurityLogs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getSecurityLogsCountAsyncWithHttpInfo
     *
     * Get business security logs count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getSecurityLogsCountAsyncAsync
     *
     * Get business security logs count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getSecurityLogsCountAsyncAsyncWithHttpInfo
     *
     * Get business security logs count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getSecurityLogsCountAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getSecurityLogsCountAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSecurityLogsCountAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/SecurityLogs/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
