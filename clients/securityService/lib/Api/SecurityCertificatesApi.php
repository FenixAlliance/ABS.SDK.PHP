...
class SecurityCertificatesApi
{
    ...
    /**
     * Operation getSecurityCertificatesAsyncWithHttpInfo
     *
     * Get security certificates
     *
    ...
    public function getSecurityCertificatesAsyncWithHttpInfo($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSecurityCertificatesAsync'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\OpenAPI\Client\Model\SecurityCertificateDtoListEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\SecurityCertificateDtoListEnvelope' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SecurityCertificateDtoListEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SecurityCertificateDtoListEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getSecurityCertificatesAsyncAsync
     *
     * Get security certificates
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getSecurityCertificatesAsyncAsyncWithHttpInfo
     *
     * Get security certificates
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getSecurityCertificatesAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getSecurityCertificatesAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSecurityCertificatesAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/SecurityCertificates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getSecurityCertificatesCountAsyncWithHttpInfo
     *
     * Get security certificates count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getSecurityCertificatesCountAsyncAsync
     *
     * Get security certificates count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Operation getSecurityCertificatesCountAsyncAsyncWithHttpInfo
     *
     * Get security certificates count
     *
     * @param  string $tenant_id (required)
    ...
    /**
     * Create request for operation 'getSecurityCertificatesCountAsync'
     *
     * @param  string $tenant_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function getSecurityCertificatesCountAsyncRequest($tenant_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getSecurityCertificatesCountAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/SecurityService/SecurityCertificates/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
