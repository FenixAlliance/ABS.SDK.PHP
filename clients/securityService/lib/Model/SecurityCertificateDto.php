...
/**
 * SecurityCertificateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecurityCertificateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityCertificateDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('expire_period', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['expire_period'];
    }

    /**
     * Sets expire_period
     *
     * @param string|null $expire_period expire_period
     *
     * @return self
     */
    public function setExpirePeriod($expire_period)
    {
        if (is_null($expire_period)) {
            array_push($this->openAPINullablesSetToNull, 'expire_period');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expire_period', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['expire_period'] = $expire_period;
