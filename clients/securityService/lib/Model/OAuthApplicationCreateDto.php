...
/**
 * OAuthApplicationCreateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OAuthApplicationCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OAuthApplicationCreateDto';
    ...
    */
    ...
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling OAuthApplicationCreateDto., must be bigger than or equal to 1.');
        }
