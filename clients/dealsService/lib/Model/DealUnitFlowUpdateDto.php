...
/**
 * DealUnitFlowUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DealUnitFlowUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DealUnitFlowUpdateDto';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DealUnitFlowUpdateDto., must be smaller than or equal to 100.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DealUnitFlowUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DealUnitFlowUpdateDto., must be smaller than or equal to 1000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DealUnitFlowUpdateDto., must be bigger than or equal to 0.');
        }
    ...
    public function setParentBusinessProcessId($parent_business_process_id)
    {
        ...
        if (!is_null($parent_business_process_id) && (mb_strlen($parent_business_process_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $parent_business_process_id when calling DealUnitFlowUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($parent_business_process_id) && (mb_strlen($parent_business_process_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $parent_business_process_id when calling DealUnitFlowUpdateDto., must be bigger than or equal to 36.');
        }
    ...
    public function setTenantId($tenant_id)
    {
        ...
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling DealUnitFlowUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($tenant_id) && (mb_strlen($tenant_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling DealUnitFlowUpdateDto., must be bigger than or equal to 36.');
        }
    ...
    public function setTenantEnrollmentId($tenant_enrollment_id)
    {
        ...
        if (!is_null($tenant_enrollment_id) && (mb_strlen($tenant_enrollment_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_enrollment_id when calling DealUnitFlowUpdateDto., must be smaller than or equal to 36.');
        }
        if (!is_null($tenant_enrollment_id) && (mb_strlen($tenant_enrollment_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_enrollment_id when calling DealUnitFlowUpdateDto., must be bigger than or equal to 36.');
        }
