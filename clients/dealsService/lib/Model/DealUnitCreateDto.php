...
class DealUnitCreateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'deal_unit_lines' => '\OpenAPI\Client\Model\DealUnitLineCreateDto[]'
    ];
    ...
    protected static $setters = [
        ...
        'deal_unit_lines' => 'setDealUnitLines'
    ];
    ...
    protected static $getters = [
        ...
        'deal_unit_lines' => 'getDealUnitLines'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('deal_unit_lines', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets deal_unit_lines
     *
     * @return \OpenAPI\Client\Model\DealUnitLineCreateDto[]|null
     */
    public function getDealUnitLines()
    {
        return $this->container['deal_unit_lines'];
    }

    /**
     * Sets deal_unit_lines
     *
     * @param \OpenAPI\Client\Model\DealUnitLineCreateDto[]|null $deal_unit_lines deal_unit_lines
     *
     * @return self
     */
    public function setDealUnitLines($deal_unit_lines)
    {
        if (is_null($deal_unit_lines)) {
            array_push($this->openAPINullablesSetToNull, 'deal_unit_lines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deal_unit_lines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['deal_unit_lines'] = $deal_unit_lines;
