...
class ResponseStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseStatus';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('utc_timestamp', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['utc_timestamp'];
    }

    /**
     * Sets utc_timestamp
     *
     * @param \DateTime|null $utc_timestamp utc_timestamp
     *
     * @return self
     */
    public function setUtcTimestamp($utc_timestamp)
    {
        if (is_null($utc_timestamp)) {
            throw new \InvalidArgumentException('non-nullable utc_timestamp cannot be null');
        }
        $this->container['utc_timestamp'] = $utc_timestamp;
