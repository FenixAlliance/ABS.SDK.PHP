...
/**
 * CountryCallingCodeDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CountryCallingCodeDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountryCallingCodeDto';
    ...
    */
    ...
    public function setCallingCode($calling_code)
    {
        if (is_null($calling_code)) {
            array_push($this->openAPINullablesSetToNull, 'calling_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('calling_code', $nullablesSetToNull);
            if ($index !== FALSE) {
