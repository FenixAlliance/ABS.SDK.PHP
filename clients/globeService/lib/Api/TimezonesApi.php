...
class TimezonesApi
{
    ...
    /**
     * Operation countTimezonesAsyncWithHttpInfo
     *
     * Count timezones
     *
    ...
    /**
     * Operation countTimezonesAsyncAsync
     *
     * Count timezones
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Operation countTimezonesAsyncAsyncWithHttpInfo
     *
     * Count timezones
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Create request for operation 'countTimezonesAsync'
     *
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['countTimezonesAsync'] to see the possible values for this operation
    ...
    public function countTimezonesAsyncRequest($api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countTimezonesAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/GlobeService/Timezones/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $api_version api_version (optional)
     * @param  string $x_api_version x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTimeZoneByIdAsync'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\ErrorEnvelope|\OpenAPI\Client\Model\TimezoneDtoEnvelope
     */
    public function getTimeZoneByIdAsync($time_zone_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getTimeZoneByIdAsync'][0])
    {
        list($response) = $this->getTimeZoneByIdAsyncWithHttpInfo($time_zone_id, $api_version, $x_api_version, $contentType);
        return $response;
    }

    /**
     * Operation getTimeZoneByIdAsyncWithHttpInfo
     *
     * Get timezone by ID
     *
     ...
     */
    public function getTimeZoneByIdAsyncWithHttpInfo($time_zone_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getTimeZoneByIdAsync'][0])
    {
        $request = $this->getTimeZoneByIdAsyncRequest($time_zone_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Operation getTimeZoneByIdAsyncAsync
     *
     * Get timezone by ID
     *
     * @param  string $time_zone_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTimeZoneByIdAsyncAsync($time_zone_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getTimeZoneByIdAsync'][0])
    {
        return $this->getTimeZoneByIdAsyncAsyncWithHttpInfo($time_zone_id, $api_version, $x_api_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTimeZoneByIdAsyncAsyncWithHttpInfo
     *
     * Get timezone by ID
     *
     * @param  string $time_zone_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTimeZoneByIdAsyncAsyncWithHttpInfo($time_zone_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getTimeZoneByIdAsync'][0])
    {
        $returnType = '\OpenAPI\Client\Model\TimezoneDtoEnvelope';
        $request = $this->getTimeZoneByIdAsyncRequest($time_zone_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Create request for operation 'getTimeZoneByIdAsync'
     *
     * @param  string $time_zone_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTimeZoneByIdAsyncRequest($time_zone_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getTimeZoneByIdAsync'][0])
    {

        // verify the required parameter 'time_zone_id' is set
        if ($time_zone_id === null || (is_array($time_zone_id) && count($time_zone_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $time_zone_id when calling getTimeZoneByIdAsync'
            );
        }
    ...
    /**
     * Operation getTimeZonesAsyncAsync
     *
     * Get all timezones
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Operation getTimeZonesAsyncAsyncWithHttpInfo
     *
     * Get all timezones
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Create request for operation 'getTimeZonesAsync'
     *
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTimeZonesAsync'] to see the possible values for this operation
