...
class LanguagesApi
{
    ...
    /**
     * Operation countLanguagesAsyncWithHttpInfo
     *
     * Count languages
     *
    ...
    /**
     * Operation countLanguagesAsyncAsync
     *
     * Count languages
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Operation countLanguagesAsyncAsyncWithHttpInfo
     *
     * Count languages
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Create request for operation 'countLanguagesAsync'
     *
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['countLanguagesAsync'] to see the possible values for this operation
    ...
    public function countLanguagesAsyncRequest($api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countLanguagesAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/GlobeService/Languages/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $api_version api_version (optional)
     * @param  string $x_api_version x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLanguageByIdAsync'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function getLanguageByIdAsync($language_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLanguageByIdAsync'][0])
    {
        list($response) = $this->getLanguageByIdAsyncWithHttpInfo($language_id, $api_version, $x_api_version, $contentType);
        return $response;
    }
     ...
     */
    public function getLanguageByIdAsyncWithHttpInfo($language_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLanguageByIdAsync'][0])
    {
        $request = $this->getLanguageByIdAsyncRequest($language_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Operation getLanguageByIdAsyncAsync
     *
     * Get language by ID
     *
     * @param  string $language_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLanguageByIdAsyncAsync($language_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLanguageByIdAsync'][0])
    {
        return $this->getLanguageByIdAsyncAsyncWithHttpInfo($language_id, $api_version, $x_api_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getLanguageByIdAsyncAsyncWithHttpInfo
     *
     * Get language by ID
     *
     * @param  string $language_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLanguageByIdAsyncAsyncWithHttpInfo($language_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLanguageByIdAsync'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CountryLanguageDtoEnvelope';
        $request = $this->getLanguageByIdAsyncRequest($language_id, $api_version, $x_api_version, $contentType);
    ...
    /**
     * Create request for operation 'getLanguageByIdAsync'
     *
     * @param  string $language_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getLanguageByIdAsyncRequest($language_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['getLanguageByIdAsync'][0])
    {

        // verify the required parameter 'language_id' is set
        if ($language_id === null || (is_array($language_id) && count($language_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $language_id when calling getLanguageByIdAsync'
            );
        }
    ...
    /**
     * Operation getLanguagesAsyncAsync
     *
     * Get all languages
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Operation getLanguagesAsyncAsyncWithHttpInfo
     *
     * Get all languages
     *
     * @param  string $api_version (optional)
    ...
    /**
     * Create request for operation 'getLanguagesAsync'
     *
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLanguagesAsync'] to see the possible values for this operation
