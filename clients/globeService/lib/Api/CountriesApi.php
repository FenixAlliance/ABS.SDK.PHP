...
class CountriesApi
{
    ...
    /**
     * Operation countCallingCodesByCountryAsyncWithHttpInfo
     *
     * Count calling codes for a country
     *
    ...
    /**
     * Operation countCallingCodesByCountryAsyncAsync
     *
     * Count calling codes for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Operation countCallingCodesByCountryAsyncAsyncWithHttpInfo
     *
     * Count calling codes for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Create request for operation 'countCallingCodesByCountryAsync'
     *
     * @param  string $country_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function countCallingCodesByCountryAsyncRequest($country_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countCallingCodesByCountryAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/GlobeService/Countries/{countryId}/CallingCodes/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation countCitiesByStateAsyncWithHttpInfo
     *
     * Count cities for a state
     *
    ...
    /**
     * Operation countCitiesByStateAsyncAsync
     *
     * Count cities for a state
     *
     * @param  string $country_state_id (required)
    ...
    /**
     * Operation countCitiesByStateAsyncAsyncWithHttpInfo
     *
     * Count cities for a state
     *
     * @param  string $country_state_id (required)
    ...
    /**
     * Create request for operation 'countCitiesByStateAsync'
     *
     * @param  string $country_state_id (required)
     * @param  string $country_id (required)
     * @param  string $api_version (optional)
    ...
    public function countCitiesByStateAsyncRequest($country_state_id, $country_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countCitiesByStateAsync'][0])
    {
        ...
        if ($country_state_id === null || (is_array($country_state_id) && count($country_state_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country_state_id when calling countCitiesByStateAsync'
            );
        }
        ...
        $resourcePath = '/api/v2/GlobeService/Countries/{countryId}/States/{countryStateId}/Cities/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation countCountryStatesAsyncWithHttpInfo
     *
     * Count states for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Operation countCountryStatesAsyncAsync
     *
     * Count states for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Operation countCountryStatesAsyncAsyncWithHttpInfo
     *
     * Count states for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Create request for operation 'countCountryStatesAsync'
     *
     * @param  string $country_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function countCountryStatesAsyncRequest($country_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countCountryStatesAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/GlobeService/Countries/{countryId}/States/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation countTimezonesByCountryAsyncWithHttpInfo
     *
     * Count timezones for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Operation countTimezonesByCountryAsyncAsync
     *
     * Count timezones for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Operation countTimezonesByCountryAsyncAsyncWithHttpInfo
     *
     * Count timezones for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Create request for operation 'countTimezonesByCountryAsync'
     *
     * @param  string $country_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function countTimezonesByCountryAsyncRequest($country_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countTimezonesByCountryAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/GlobeService/Countries/{countryId}/Timezones/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation countTopLevelDomainsByCountryAsyncWithHttpInfo
     *
     * Count top-level domains for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Operation countTopLevelDomainsByCountryAsyncAsync
     *
     * Count top-level domains for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Operation countTopLevelDomainsByCountryAsyncAsyncWithHttpInfo
     *
     * Count top-level domains for a country
     *
     * @param  string $country_id (required)
    ...
    /**
     * Create request for operation 'countTopLevelDomainsByCountryAsync'
     *
     * @param  string $country_id (required)
     * @param  string $api_version (optional)
     * @param  string $x_api_version (optional)
    ...
    public function countTopLevelDomainsByCountryAsyncRequest($country_id, $api_version = null, $x_api_version = null, string $contentType = self::contentTypes['countTopLevelDomainsByCountryAsync'][0])
    {
        ...
        $resourcePath = '/api/v2/GlobeService/Countries/{countryId}/TopLevelDomains/Count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
